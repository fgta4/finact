...
/**
 * finact/sales/orderintype/apis/ref-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel ref orderintype (mst_orderintype)
 *
...
$API = new class extends orderintypeBase {
	...
	public function execute($data, $options) {
		$tablename = 'mst_orderintyperef';
		$primarykey = 'orderintyperef_id';
		...
		try {
			...
			$obj->orderintyperef_id = strtoupper($obj->orderintyperef_id);
			$obj->interface_id = strtoupper($obj->interface_id);
			$obj->orderintype_id = strtoupper($obj->orderintype_id);
			...
			try {
				...
				$header_table = 'mst_orderintype';
				$header_primarykey = 'orderintype_id';
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'orderintyperef_id', 'interface_id', 'orderintyperef_code', 'orderintype_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

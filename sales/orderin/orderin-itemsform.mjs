...
const obj = {
	txt_orderinitem_id: $('#pnl_edititemsform-txt_orderinitem_id'),
	...
	txt_orderin_id: $('#pnl_edititemsform-txt_orderin_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_orderinitem_id,
		autoid: true,
		logview: 'trn_orderinitem',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_orderinitem_id

...
/**
 * finact/sales/orderin/apis/terms-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends orderinBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->orderinterm_dtfrometa = (\DateTime::createFromFormat('d/m/Y',$obj->orderinterm_dtfrometa))->format('Y-m-d');
			$obj->orderinterm_dt = (\DateTime::createFromFormat('d/m/Y',$obj->orderinterm_dt))->format('Y-m-d');



			if ($obj->orderinterm_descr=='') { $obj->orderinterm_descr = '--NULL--'; }

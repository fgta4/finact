...
/**
 * finact/sales/orderin/apis/terms-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel terms orderin (trn_orderin)
...
$API = new class extends orderinBase {
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("select count(*) as n from trn_orderinterm A" . $where->sql);

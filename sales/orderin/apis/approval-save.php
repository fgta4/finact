...
/**
 * finact/sales/orderin/apis/approval-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel approval orderin (trn_orderin)
 *
...
$API = new class extends orderinBase {
	...
	public function execute($data, $options) {
		$tablename = 'trn_orderinappr';
		$primarykey = 'orderinappr_id';
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'orderinappr_id', 'orderinappr_isapproved', 'orderinappr_by', 'orderinappr_date', 'orderin_version', 'orderinappr_isdeclined', 'orderinappr_declinedby', 'orderinappr_declineddate', 'orderinappr_notes', 'orderin_id', 'docauth_descr', 'docauth_order', 'docauth_value', 'docauth_min', 'authlevel_id', 'authlevel_name', 'auth_id', 'auth_name', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

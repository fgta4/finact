...
/**
 * finact/sales/orderin/apis/items-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel items orderin (trn_orderin)
 *
...
$API = new class extends orderinBase {
	...
	public function execute($data, $options) {
		$tablename = 'trn_orderinitem';
		$primarykey = 'orderinitem_id';
		...
		try {
			...
			try {
				...
				$header_table = 'trn_orderin';
				$header_primarykey = 'orderin_id';
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'orderinitem_id', 'itemclass_id', 'orderinitem_descr', 'orderinitem_qty', 'orderinitem_price', 'orderinitem_pricediscpercent', 'orderinitem_pricediscvalue', 'orderinitem_subtotal', 'accbudget_id', 'coa_id', 'orderin_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

...
const obj = {
	txt_orderinappr_id: $('#pnl_editapprovalform-txt_orderinappr_id'),
	chk_orderinappr_isapproved: $('#pnl_editapprovalform-chk_orderinappr_isapproved'),
	txt_orderinappr_by: $('#pnl_editapprovalform-txt_orderinappr_by'),
	txt_orderinappr_date: $('#pnl_editapprovalform-txt_orderinappr_date'),
	txt_orderin_version: $('#pnl_editapprovalform-txt_orderin_version'),
	chk_orderinappr_isdeclined: $('#pnl_editapprovalform-chk_orderinappr_isdeclined'),
	txt_orderinappr_declinedby: $('#pnl_editapprovalform-txt_orderinappr_declinedby'),
	txt_orderinappr_declineddate: $('#pnl_editapprovalform-txt_orderinappr_declineddate'),
	txt_orderinappr_notes: $('#pnl_editapprovalform-txt_orderinappr_notes'),
	txt_orderin_id: $('#pnl_editapprovalform-txt_orderin_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_orderinappr_id,
		autoid: true,
		logview: 'trn_orderinappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.orderin_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_orderinappr_id

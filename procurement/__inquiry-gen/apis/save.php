...
/**
 * finact/procurement/inquiry-gen/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header inquiry-gen (trn_inquiry)
 *
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'inquiry_id', 'inquirytype_id', 'inquiry_descr', 'inquiry_dtstart', 'inquiry_dtend', 'user_dept_id', 'empl_id', 'inquiry_isadvance', 'project_id', 'projecttask_id', 'projbudget_id', 'projbudgettask_id', 'inquiry_isunbudgetted', 'site_id', 'deliver_siteaddress', 'deliver_city', 'deliver_upname', 'deliver_uptelp', 'inquirymodel_id', 'inquiryselect_id', 'related_dept_id', 'owner_dept_id', 'request_doc_id', 'orderout_dept_id', 'orderout_doc_id', 'trxmodel_id', 'itemmanage_id', 'inquiry_rejectnotes', 'doc_id', 'inquiry_selectfield', 'inquiry_version', 'inquiry_maxadvancevalue', 'inquiry_isallowadvance', 'inquiry_isdateinterval', 'inquiry_iscommit', 'inquiry_commitby', 'inquiry_commitdate', 'inquiry_isapprovalprogress', 'inquiry_isapproved', 'inquiry_approveby', 'inquiry_approvedate', 'inquiry_isdeclined', 'inquiry_declineby', 'inquiry_declinedate', 'inquiry_ispreparing', 'inquiry_isprepared', 'inquiry_preparedby', 'inquiry_prepareddate', 'inquiry_isreject', 'inquiry_rejectby', 'inquiry_rejectdate', 'inquiry_iscomplete', 'inquiry_isclose', 'inquiry_closeby', 'inquiry_closedate', 'inquiry_isautogenerated', 'inquiry_isitemdeptuser', 'inquiry_isitemdeptowner', 'inquiry_istoberequest', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

...
const obj = {
	...
	txt_inquiryselect_name: $('#pnl_edit-txt_inquiryselect_name'),
	txt_inquiryselect_descr: $('#pnl_edit-txt_inquiryselect_descr'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_inquiryselect_id,
		autoid: false,
		logview: 'mst_inquiryselect',
...
function form_idsetup(options) {
	var objid = obj.txt_inquiryselect_id

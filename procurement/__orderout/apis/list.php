	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.orderout_id, A.unit_id, A.request_id, A.orderout_isunref, A.inquirytype_id, A.trxmodel_id, A.request_dept_id, A.orderout_descr, A.orderout_dtstart, A.orderout_dtend, A.curr_id, A.curr_rate, A.ppn_taxtype_id, A.pph_taxtype_id, A.partner_id, A.ordercontract_id, A.orderout_quot, A.paymtype_id, A.partnerbank_id, A.partnerbank_name, A.partnerbank_bankacc, A.partnerbank_bankaccname, A.partnerbank_bankname, A.partnercontact_id, A.partnercontact_upname, A.partnercontact_position, A.partnercontact_upphone, A.partnercontact_email, A.project_id, A.projecttask_id, A.projbudget_id, A.projbudgettask_id, A.orderout_isunbudgetted, A.site_id, A.user_dept_id, A.recv_dept_id, A.deliver_siteaddress, A.deliver_city, A.deliver_upname, A.deliver_uptelp, A.inquiry_id, A.orderout_ismultirequest, A.inquirymodel_id, A.inquiryselect_id, A.itemmanage_id, A.owner_dept_id, A.orderout_dept_id, A.doc_id, A.orderout_version, A.orderout_isdateinterval, A.orderout_iscommit, A.orderout_commitby, A.orderout_commitdate, A.orderout_isapprovalprogress, A.orderout_isapproved, A.orderout_approveby, A.orderout_approvedate, A.orderout_isdeclined, A.orderout_declineby, A.orderout_declinedate, A.orderout_isclose, A.orderout_closeby, A.orderout_closedate, A.orderout_isadvance, A.orderout_isautogenerated, A.orderout_isitemdeptuser, A.orderout_isitemdeptowner, A._createby, A._createdate, A._modifyby, A._modifydate 
				from trn_orderout A
			" . $where->sql . $limit);
			$stmt->execute($where->params);

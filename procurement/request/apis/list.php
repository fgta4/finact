	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.request_id, A.inquiry_id, A.request_isunref, A.inquirytype_id, A.user_dept_id, A.request_descr, A.trxmodel_id, A.request_dtstart, A.request_dtend, A.project_id, A.projecttask_id, A.projbudget_id, A.projbudgettask_id, A.request_isunbudgetted, A.site_id, A.deliver_siteaddress, A.deliver_city, A.deliver_upname, A.deliver_uptelp, A.inquirymodel_id, A.inquiryselect_id, A.itemmanage_id, A.owner_dept_id, A.orderout_dept_id, A.orderout_doc_id, A.doc_id, A.request_version, A.request_isdateinterval, A.request_iscommit, A.request_commitby, A.request_commitdate, A.request_isapprovalprogress, A.request_isapproved, A.request_approveby, A.request_approvedate, A.request_isdeclined, A.request_declineby, A.request_declinedate, A.request_isclose, A.request_closeby, A.request_closedate, A.request_isautogenerated, A.request_isitemdeptuser, A.request_isitemdeptowner, A._createby, A._createdate, A._modifyby, A._modifydate 
				from trn_request A
			" . $where->sql . $limit);
			$stmt->execute($where->params);

	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.inquirytype_id, A.inquirymodel_id, A.inquirytype_name, A.inquirytype_descr, A.trxmodel_id, A.inquirytype_isallowadvance, A.inquirytype_maxadvancevalue, A.inquiryselect_id, A.inquiry_title_ina, A.inquiry_title_eng, A.inquiry_doc_id, A.owner_dept_id, A.owner_team_id, A.request_title_ina, A.request_title_eng, A.request_doc_id, A.orderout_dept_id, A.orderout_team_id, A.orderout_title_ina, A.orderout_title_eng, A.orderout_doc_id, A.itemmanage_id, A.inquirytype_isdeptuser, A.inquirytype_isdeptowner, A.inquirytype_istoberequest, A.inquirytype_isautorequest, A.inquirytype_isautoorder, A.inquirytype_ismovinginit, A.inquirytype_isdateinterval, A._createby, A._createdate, A._modifyby, A._modifydate 

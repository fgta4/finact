...
/**
 * finact/procurement/request/apis/approval-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel approval request (trn_request)
 *
...
$API = new class extends requestBase {
	...
	public function execute($data, $options) {
		$tablename = 'trn_requestappr';
		$primarykey = 'requestappr_id';
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'requestappr_id', 'requestappr_isapproved', 'requestappr_by', 'requestappr_date', 'request_version', 'requestappr_isdeclined', 'requestappr_declinedby', 'requestappr_declineddate', 'requestappr_notes', 'request_id', 'docauth_descr', 'docauth_order', 'docauth_value', 'docauth_min', 'authlevel_id', 'authlevel_name', 'auth_id', 'auth_name', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

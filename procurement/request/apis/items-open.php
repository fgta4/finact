...
/**
 * finact/procurement/request/apis/items-open.php
 *
 * ==========
 * Detil-Open
 * ==========
	...
	public function execute($options) {
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"requestitem_id" => " requestitem_id = :requestitem_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('trn_requestitem A', [
				'requestitem_id', 'itemasset_id', 'item_id', 'itemstock_id', 'partner_id', 'itemclass_id', 'requestitem_descr', 'requestitem_qty', 'requestitem_days', 'requestitem_task', 'requestitem_estrate', 'requestitem_estvalue', 'projbudgetdet_id', 'requestitem_isunbudget', 'requestitem_isallowoverbudget', 'requestitem_value', 'requestitem_budgetavailable', 'requestitem_qtyavailable', 'accbudget_id', 'coa_id', 'inquiry_id', 'inquirydetil_id', 'request_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);

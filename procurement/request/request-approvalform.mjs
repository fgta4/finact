...
const obj = {
	txt_requestappr_id: $('#pnl_editapprovalform-txt_requestappr_id'),
	chk_requestappr_isapproved: $('#pnl_editapprovalform-chk_requestappr_isapproved'),
	txt_requestappr_by: $('#pnl_editapprovalform-txt_requestappr_by'),
	txt_requestappr_date: $('#pnl_editapprovalform-txt_requestappr_date'),
	txt_request_version: $('#pnl_editapprovalform-txt_request_version'),
	chk_requestappr_isdeclined: $('#pnl_editapprovalform-chk_requestappr_isdeclined'),
	txt_requestappr_declinedby: $('#pnl_editapprovalform-txt_requestappr_declinedby'),
	txt_requestappr_declineddate: $('#pnl_editapprovalform-txt_requestappr_declineddate'),
	txt_requestappr_notes: $('#pnl_editapprovalform-txt_requestappr_notes'),
	txt_request_id: $('#pnl_editapprovalform-txt_request_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_requestappr_id,
		autoid: true,
		logview: 'trn_requestappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.request_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_requestappr_id

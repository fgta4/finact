...
/**
 * finact/procurement/inquiryprocess/apis/item-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel item inquiryprocess (trn_inquiry)
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.inquirydetil_id, A.itemasset_id, A.item_id, A.itemstock_id, A.itemclass_id, A.inquirydetil_descr, A.inquirydetil_qty, A.inquirydetil_days, A.inquirydetil_task, A.partner_id, A.inquirydetil_estrate, A.inquirydetil_estvalue, A.inquirydetil_isadvproces, A.projbudgetdet_id, A.inquirydetil_isunbudget, A.inquirydetil_isallowoverbudget, A.inquirydetil_qtyavailable, A.accbudget_id, A.coa_id, A.inquiry_id, A._createby, A._createdate, A._modifyby, A._modifydate 

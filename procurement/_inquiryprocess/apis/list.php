...
/**
 * finact/procurement/inquiryprocess/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header inquiryprocess (trn_inquiry)
		...
		try {
			...
			foreach ($rows as $row) {
				...
				array_push($records, array_merge($record, [
					...
					'request_dept_id' => \FGTA4\utils\SqlUtility::Lookup($record['request_dept_id'], $this->db, 'mst_dept', 'dept_id', 'dept_name'),

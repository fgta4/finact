...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.inquiry_isemplaspartner = '0'
...
async function form_datasaving(data, options) {
	...
	// options.skipmappingresponse = ['empl_id', 'projecttask_id', 'projbudgettask_id', 'partner_id', ];
...
function btn_print_click() {
	...
	var printurl = 'index.php/printout/' + window.global.modulefullname + '/inquiryprocess.xprint?id=' + id;
...
async function btn_action_click(args) {
	...
	switch (args.action) {
		case 'generaterequest':
			args.act_url = `finact/procurement/inquiry/xtion-${args.action}`;

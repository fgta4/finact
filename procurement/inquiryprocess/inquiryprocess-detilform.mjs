...
const obj = {
	txt_inquirydetil_id: $('#pnl_editdetilform-txt_inquirydetil_id'),
	cbo_itemasset_id: $('#pnl_editdetilform-cbo_itemasset_id'),
	cbo_item_id: $('#pnl_editdetilform-cbo_item_id'),
	cbo_itemstock_id: $('#pnl_editdetilform-cbo_itemstock_id'),
	cbo_partner_id: $('#pnl_editdetilform-cbo_partner_id'),
	cbo_itemclass_id: $('#pnl_editdetilform-cbo_itemclass_id'),
	txt_inquirydetil_descr: $('#pnl_editdetilform-txt_inquirydetil_descr'),
	txt_inquirydetil_qty: $('#pnl_editdetilform-txt_inquirydetil_qty'),
	txt_inquirydetil_days: $('#pnl_editdetilform-txt_inquirydetil_days'),
	txt_inquirydetil_task: $('#pnl_editdetilform-txt_inquirydetil_task'),
	txt_inquirydetil_estrate: $('#pnl_editdetilform-txt_inquirydetil_estrate'),
	txt_inquirydetil_estvalue: $('#pnl_editdetilform-txt_inquirydetil_estvalue'),
	cbo_projbudgetdet_id: $('#pnl_editdetilform-cbo_projbudgetdet_id'),
	chk_inquirydetil_isunbudget: $('#pnl_editdetilform-chk_inquirydetil_isunbudget'),
	chk_inquirydetil_isallowoverbudget: $('#pnl_editdetilform-chk_inquirydetil_isallowoverbudget'),
	txt_inquirydetil_qtyavailable: $('#pnl_editdetilform-txt_inquirydetil_qtyavailable'),
	txt_accbudget_id: $('#pnl_editdetilform-txt_accbudget_id'),
	txt_coa_id: $('#pnl_editdetilform-txt_coa_id'),
	txt_inquiry_id: $('#pnl_editdetilform-txt_inquiry_id')
}
...
export async function init(opt) {
	...
	obj.cbo_itemasset_id.name = 'pnl_editdetilform-cbo_itemasset_id'		
	...
	obj.cbo_item_id.name = 'pnl_editdetilform-cbo_item_id'		
	...
	obj.cbo_itemstock_id.name = 'pnl_editdetilform-cbo_itemstock_id'		

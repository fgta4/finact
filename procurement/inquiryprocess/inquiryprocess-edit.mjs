...
import * as hnd from  './inquiryprocess-edit-hnd.mjs'
...
export async function init(opt) {
	...
	new fgta4slideselect(obj.cbo_inquirytype_id, {
		...
		OnDataLoaded : (result, options) => {
			...
			if (typeof hnd.cbo_inquirytype_id_dataloaded === 'function') {
				hnd.cbo_inquirytype_id_dataloaded(result, options);
			}
		},

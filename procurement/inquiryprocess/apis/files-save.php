...
/**
 * finact/procurement/inquiryprocess/apis/files-save.php
 *
 * ==========
 * Detil-Save
 * ==========
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'inquiryfiles_id', 'doctype_id', 'inquiryfiles_descr', 'inquiryfiles_order', 'inquiryfiles_file', 'inquiry_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

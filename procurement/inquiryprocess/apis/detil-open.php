...
/**
 * finact/procurement/inquiryprocess/apis/detil-open.php
 *
 * ==========
 * Detil-Open
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel detil} inquiryprocess (trn_inquiry)
 *
...
$API = new class extends inquiryprocessBase {
	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('trn_inquirydetil A', [
				'inquirydetil_id', 'itemasset_id', 'item_id', 'itemstock_id', 'partner_id', 'itemclass_id', 'inquirydetil_descr', 'inquirydetil_qty', 'inquirydetil_days', 'inquirydetil_task', 'inquirydetil_estrate', 'inquirydetil_estvalue', 'projbudgetdet_id', 'inquirydetil_isunbudget', 'inquirydetil_isallowoverbudget', 'inquirydetil_qtyavailable', 'accbudget_id', 'coa_id', 'inquiry_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);

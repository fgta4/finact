...
import * as hnd from  './orderout-filesform-hnd.mjs'
...
const fl_orderoutfiles_file_img = $('#pnl_editfilesform-fl_orderoutfiles_file_img');
const fl_orderoutfiles_file_lnk = $('#pnl_editfilesform-fl_orderoutfiles_file_link');				
			

const pnl_form = $('#pnl_editfilesform-form')
const obj = {
	txt_orderoutfiles_id: $('#pnl_editfilesform-txt_orderoutfiles_id'),
	cbo_doctype_id: $('#pnl_editfilesform-cbo_doctype_id'),
	txt_orderoutfiles_descr: $('#pnl_editfilesform-txt_orderoutfiles_descr'),
	txt_orderoutfiles_order: $('#pnl_editfilesform-txt_orderoutfiles_order'),
	fl_orderoutfiles_file: $('#pnl_editfilesform-fl_orderoutfiles_file'),
	txt_orderout_id: $('#pnl_editfilesform-txt_orderout_id')
}
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.orderout_descr)

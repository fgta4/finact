...
const txt_caption = $('#pnl_editapprovalform-caption')
...
const obj = {
	txt_orderoutappr_id: $('#pnl_editapprovalform-txt_orderoutappr_id'),
	chk_orderoutappr_isapproved: $('#pnl_editapprovalform-chk_orderoutappr_isapproved'),
	txt_orderoutappr_by: $('#pnl_editapprovalform-txt_orderoutappr_by'),
	txt_orderoutappr_date: $('#pnl_editapprovalform-txt_orderoutappr_date'),
	txt_orderout_version: $('#pnl_editapprovalform-txt_orderout_version'),
	chk_orderoutappr_isdeclined: $('#pnl_editapprovalform-chk_orderoutappr_isdeclined'),
	txt_orderoutappr_declinedby: $('#pnl_editapprovalform-txt_orderoutappr_declinedby'),
	txt_orderoutappr_declineddate: $('#pnl_editapprovalform-txt_orderoutappr_declineddate'),
	txt_orderoutappr_notes: $('#pnl_editapprovalform-txt_orderoutappr_notes'),
	txt_orderout_id: $('#pnl_editapprovalform-txt_orderout_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_orderoutappr_id,
		autoid: true,
		logview: 'trn_orderoutappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.orderout_id)
...
function form_idsetup(options) {
	var objid = obj.txt_orderoutappr_id

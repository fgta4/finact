...
if (is_file(__DIR__ .'/orderout.php-handler.php')) {
	require_once __DIR__ .'/orderout.php-handler.php';
}

/**
 * finact/procurement/orderout/orderout.php
 *
 * ===================================================================
 * Entry point Program Module orderout
 * ===================================================================
 ...
 * terakhir di generate tanggal 01/11/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\orderout_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new orderout_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

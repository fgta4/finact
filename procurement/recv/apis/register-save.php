...
/**
 * finact/procurement/recv/apis/register-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel register recv (trn_recv)
 *
...
$API = new class extends recvBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			if ($obj->recvitem_serial=='') { $obj->recvitem_serial = '--NULL--'; }
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'recvitemreg_id', 'recvitem_descr', 'recvitem_serial', 'item_id', 'itemclass_id', 'recvitem_qty', 'recvitem_value', 'recvitem_idr', 'curr_id', 'accbudget_id', 'coa_id', 'orderout_id', 'orderoutitem_id', 'request_id', 'requestitem_id', 'inquiry_id', 'inquiryitem_id', 'recv_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

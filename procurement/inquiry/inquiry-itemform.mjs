...
import * as hnd from  './inquiry-itemform-hnd.mjs'
...
const obj = {
	...
	txt_inquirydetil_ref: $('#pnl_edititemform-txt_inquirydetil_ref'),
	txt_inquirydetil_refname: $('#pnl_edititemform-txt_inquirydetil_refname'),
...
async function form_datasaving(data, options) {
	...
	// options.skipmappingresponse = ['item_id', 'itemstock_id', 'partner_id', 'projbudgetdet_id', ];

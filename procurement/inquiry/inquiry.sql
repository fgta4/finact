...
CREATE TABLE IF NOT EXISTS `trn_inquiry` (
	...
	`paymtype_isviabank` tinyint(1) NOT NULL DEFAULT 0, 
	...
	`inquiry_isindependentsetting` tinyint(1) NOT NULL DEFAULT 0, 
...
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `request_dept_id` varchar(30)   AFTER `inquirytype_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiry_descr` varchar(255)   AFTER `request_dept_id`;
...
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `partner_name` varchar(60) NOT NULL  AFTER `partner_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `paymtype_id` varchar(6)   AFTER `partner_name`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `paymtype_isviabank` tinyint(1) NOT NULL DEFAULT 0 AFTER `paymtype_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `partnerbank_id` varchar(30)   AFTER `paymtype_isviabank`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `paymto_bankacc` varchar(90)   AFTER `partnerbank_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `paymto_bankaccname` varchar(90)   AFTER `paymto_bankacc`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `paymto_bankname` varchar(90)   AFTER `paymto_bankaccname`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `partnercontact_id` varchar(14)   AFTER `paymto_bankname`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `partnercontact_upname` varchar(90) NOT NULL  AFTER `partnercontact_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `partnercontact_position` varchar(90) NOT NULL  AFTER `partnercontact_upname`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `partnercontact_upphone` varchar(90) NOT NULL  AFTER `partnercontact_position`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `partnercontact_email` varchar(90) NOT NULL  AFTER `partnercontact_upphone`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `project_id` varchar(30) NOT NULL  AFTER `partnercontact_email`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `projecttask_id` varchar(14)   AFTER `project_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiry_isunbudgetted` tinyint(1) NOT NULL DEFAULT 0 AFTER `projecttask_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `projbudget_id` varchar(30)   AFTER `inquiry_isunbudgetted`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `projbudgettask_id` varchar(14)   AFTER `projbudget_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `site_id` varchar(30) NOT NULL  AFTER `projbudgettask_id`;
...
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `doc_id` varchar(30) NOT NULL  AFTER `deliver_uptelp`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiry_version` int(4) NOT NULL DEFAULT 0 AFTER `doc_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiry_rejectnotes` varchar(255)   AFTER `inquiry_version`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirymodel_id` varchar(1) NOT NULL  AFTER `inquiry_rejectnotes`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `itemmanage_id` varchar(2) NOT NULL  AFTER `inquirymodel_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiry_isindependentsetting` tinyint(1) NOT NULL DEFAULT 0 AFTER `itemmanage_id`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiryselect_isshowitemasset` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquiry_isindependentsetting`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiryselect_isshowitem` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquiryselect_isshowitemasset`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiryselect_isshowitemstock` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquiryselect_isshowitem`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiryselect_isshowpartner` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquiryselect_isshowitemstock`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiryselect_isshowitemclass` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquiryselect_isshowpartner`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiryselect_isitemclassdisabled` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquiryselect_isshowitemclass`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isuseqty` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquiryselect_isitemclassdisabled`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isusedays` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isuseqty`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isusetask` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isusedays`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isdateinterval` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isusetask`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_istoberequest` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isdateinterval`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isautorequest` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_istoberequest`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isautoorder` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isautorequest`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_ismovinginit` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isautoorder`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_islimitqty` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_ismovinginit`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_islimitdays` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_islimitqty`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_islimittask` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_islimitdays`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_islimitvalue` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_islimittask`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isallowunbudget` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_islimitvalue`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isallowitemunbudget` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isallowunbudget`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isallowoverbudget` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isallowitemunbudget`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isallowadvance` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isallowoverbudget`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_isemplaspartner` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_isallowadvance`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquirytype_maxadvancevalue` decimal(12, 0) NOT NULL DEFAULT 0 AFTER `inquirytype_isemplaspartner`;
ALTER TABLE `trn_inquiry` ADD COLUMN IF NOT EXISTS  `inquiry_iscommit` tinyint(1) NOT NULL DEFAULT 0 AFTER `inquirytype_maxadvancevalue`;
...
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `request_dept_id` varchar(30)    AFTER `inquirytype_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiry_descr` varchar(255)    AFTER `request_dept_id`;
...
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `partner_id` varchar(30)    AFTER `inquiry_isadvance`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `partner_name` varchar(60) NOT NULL   AFTER `partner_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `paymtype_id` varchar(6)    AFTER `partner_name`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `paymtype_isviabank` tinyint(1) NOT NULL DEFAULT 0  AFTER `paymtype_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `partnerbank_id` varchar(30)    AFTER `paymtype_isviabank`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `paymto_bankacc` varchar(90)    AFTER `partnerbank_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `paymto_bankaccname` varchar(90)    AFTER `paymto_bankacc`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `paymto_bankname` varchar(90)    AFTER `paymto_bankaccname`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `partnercontact_id` varchar(14)    AFTER `paymto_bankname`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `partnercontact_upname` varchar(90) NOT NULL   AFTER `partnercontact_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `partnercontact_position` varchar(90) NOT NULL   AFTER `partnercontact_upname`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `partnercontact_upphone` varchar(90) NOT NULL   AFTER `partnercontact_position`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `partnercontact_email` varchar(90) NOT NULL   AFTER `partnercontact_upphone`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `project_id` varchar(30) NOT NULL   AFTER `partnercontact_email`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `projecttask_id` varchar(14)    AFTER `project_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiry_isunbudgetted` tinyint(1) NOT NULL DEFAULT 0  AFTER `projecttask_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `projbudget_id` varchar(30)    AFTER `inquiry_isunbudgetted`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `projbudgettask_id` varchar(14)    AFTER `projbudget_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `site_id` varchar(30) NOT NULL   AFTER `projbudgettask_id`;
...
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `doc_id` varchar(30) NOT NULL   AFTER `deliver_uptelp`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiry_version` int(4) NOT NULL DEFAULT 0  AFTER `doc_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiry_rejectnotes` varchar(255)    AFTER `inquiry_version`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirymodel_id` varchar(1) NOT NULL   AFTER `inquiry_rejectnotes`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `itemmanage_id` varchar(2) NOT NULL   AFTER `inquirymodel_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiry_isindependentsetting` tinyint(1) NOT NULL DEFAULT 0  AFTER `itemmanage_id`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiryselect_isshowitemasset` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquiry_isindependentsetting`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiryselect_isshowitem` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquiryselect_isshowitemasset`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiryselect_isshowitemstock` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquiryselect_isshowitem`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiryselect_isshowpartner` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquiryselect_isshowitemstock`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiryselect_isshowitemclass` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquiryselect_isshowpartner`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiryselect_isitemclassdisabled` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquiryselect_isshowitemclass`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isuseqty` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquiryselect_isitemclassdisabled`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isusedays` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_isuseqty`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isusetask` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_isusedays`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isdateinterval` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_isusetask`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_istoberequest` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_isdateinterval`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isautorequest` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_istoberequest`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isautoorder` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_isautorequest`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_ismovinginit` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_isautoorder`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_islimitqty` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_ismovinginit`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_islimitdays` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_islimitqty`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_islimittask` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_islimitdays`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_islimitvalue` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_islimittask`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isallowunbudget` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_islimitvalue`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isallowitemunbudget` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_isallowunbudget`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isallowoverbudget` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_isallowitemunbudget`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isallowadvance` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_isallowoverbudget`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_isemplaspartner` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_isallowadvance`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquirytype_maxadvancevalue` decimal(12, 0) NOT NULL DEFAULT 0  AFTER `inquirytype_isemplaspartner`;
ALTER TABLE `trn_inquiry` MODIFY COLUMN IF EXISTS  `inquiry_iscommit` tinyint(1) NOT NULL DEFAULT 0  AFTER `inquirytype_maxadvancevalue`;
...
ALTER TABLE `trn_inquiry` ADD CONSTRAINT `fk_trn_inquiry_mst_dept` FOREIGN KEY IF NOT EXISTS  (`request_dept_id`) REFERENCES `mst_dept` (`dept_id`);
ALTER TABLE `trn_inquiry` ADD CONSTRAINT `fk_trn_inquiry_mst_dept_2` FOREIGN KEY IF NOT EXISTS  (`user_dept_id`) REFERENCES `mst_dept` (`dept_id`);
...
ALTER TABLE `trn_inquiry` ADD CONSTRAINT `fk_trn_inquiry_mst_doc` FOREIGN KEY IF NOT EXISTS  (`doc_id`) REFERENCES `mst_doc` (`doc_id`);
...
CREATE TABLE IF NOT EXISTS `trn_inquirydetil` (
	...
	`inquirydetil_ref` varchar(90)  , 
	`inquirydetil_refname` varchar(200)  , 
...
ALTER TABLE `trn_inquirydetil` ADD COLUMN IF NOT EXISTS  `inquirydetil_ref` varchar(90)   AFTER `inquirydetil_estvalue`;
ALTER TABLE `trn_inquirydetil` ADD COLUMN IF NOT EXISTS  `inquirydetil_refname` varchar(200)   AFTER `inquirydetil_ref`;
ALTER TABLE `trn_inquirydetil` ADD COLUMN IF NOT EXISTS  `projbudgetdet_id` varchar(30)   AFTER `inquirydetil_refname`;
...
ALTER TABLE `trn_inquirydetil` MODIFY COLUMN IF EXISTS  `inquirydetil_ref` varchar(90)    AFTER `inquirydetil_estvalue`;
ALTER TABLE `trn_inquirydetil` MODIFY COLUMN IF EXISTS  `inquirydetil_refname` varchar(200)    AFTER `inquirydetil_ref`;
ALTER TABLE `trn_inquirydetil` MODIFY COLUMN IF EXISTS  `projbudgetdet_id` varchar(30)    AFTER `inquirydetil_refname`;

...
/**
 * finact/procurement/ordercontract/apis/item-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel item ordercontract (trn_ordercontract)
 *
...
$API = new class extends ordercontractBase {
	...
	public function execute($data, $options) {
		$tablename = 'trn_ordercontractitem';
		$primarykey = 'ordercontractitem_id';
		...
		try {
			...
			$obj->ordercontractitem_id = strtoupper($obj->ordercontractitem_id);

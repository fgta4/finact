...
/**
 * finact/procurement/ordercontract/apis/approval-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel approval ordercontract (trn_ordercontract)
 *
...
$API = new class extends ordercontractBase {
	...
	public function execute($data, $options, $files) {
		$tablename = 'trn_ordercontractappr';
		$primarykey = 'ordercontractappr_id';
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'ordercontractappr_id', 'ordercontractappr_isapproved', 'ordercontractappr_by', 'ordercontractappr_date', 'ordercontract_version', 'ordercontractappr_isdeclined', 'ordercontractappr_declinedby', 'ordercontractappr_declineddate', 'ordercontractappr_notes', 'ordercontract_id', 'docauth_descr', 'docauth_order', 'docauth_value', 'docauth_min', 'authlevel_id', 'authlevel_name', 'auth_id', 'auth_name', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

...
const obj = {
	txt_ordercontractappr_id: $('#pnl_editapprovalform-txt_ordercontractappr_id'),
	chk_ordercontractappr_isapproved: $('#pnl_editapprovalform-chk_ordercontractappr_isapproved'),
	txt_ordercontractappr_by: $('#pnl_editapprovalform-txt_ordercontractappr_by'),
	txt_ordercontractappr_date: $('#pnl_editapprovalform-txt_ordercontractappr_date'),
	txt_ordercontract_version: $('#pnl_editapprovalform-txt_ordercontract_version'),
	chk_ordercontractappr_isdeclined: $('#pnl_editapprovalform-chk_ordercontractappr_isdeclined'),
	txt_ordercontractappr_declinedby: $('#pnl_editapprovalform-txt_ordercontractappr_declinedby'),
	txt_ordercontractappr_declineddate: $('#pnl_editapprovalform-txt_ordercontractappr_declineddate'),
	txt_ordercontractappr_notes: $('#pnl_editapprovalform-txt_ordercontractappr_notes'),
	txt_ordercontract_id: $('#pnl_editapprovalform-txt_ordercontract_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_ordercontractappr_id,
		autoid: true,
		logview: 'trn_ordercontractappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.ordercontract_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_ordercontractappr_id

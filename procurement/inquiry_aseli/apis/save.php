		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename . " A", [
					...
					, 'project_id', 'projecttask_id', 'projbudget_id', 'projbudgettask_id', 'inquiry_isunbudgetted'
					, 'site_id', 'deliver_siteaddress', 'deliver_city', 'deliver_upname', 'deliver_uptelp'
					, 'inquirymodel_id', 'inquiryselect_id', 'owner_dept_id', 'request_dept_id', 'request_doc_id', 'orderout_dept_id', 'orderout_doc_id', 'trxmodel_id'
					, 'itemmanage_id', 'inquiry_rejectnotes', 'doc_id', 'inquiry_selectfield', 'inquiry_version', 'inquiry_maxadvancevalue', 'inquiry_isallowadvance', 'inquiry_isallowoverbudget'
					...
					, 'inquiry_isreject', 'inquiry_rejectby', 'inquiry_rejectdate', 'inquiry_iscomplete'
					, 'inquiry_isclose', 'inquiry_closeby', 'inquiry_closedate', 'inquiry_isautogenerated'
					, 'inquiry_isitemdeptuser', 'inquiry_isitemdeptowner', 'inquiry_istoberequest'

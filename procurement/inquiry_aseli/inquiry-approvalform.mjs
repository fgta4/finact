...
const obj = {
	txt_inquiryappr_id: $('#pnl_editapprovalform-txt_inquiryappr_id'),
	chk_inquiryappr_isapproved: $('#pnl_editapprovalform-chk_inquiryappr_isapproved'),
	txt_inquiryappr_by: $('#pnl_editapprovalform-txt_inquiryappr_by'),
	txt_inquiryappr_date: $('#pnl_editapprovalform-txt_inquiryappr_date'),
	txt_inquiry_version: $('#pnl_editapprovalform-txt_inquiry_version'),
	chk_inquiryappr_isdeclined: $('#pnl_editapprovalform-chk_inquiryappr_isdeclined'),
	txt_inquiryappr_declinedby: $('#pnl_editapprovalform-txt_inquiryappr_declinedby'),
	txt_inquiryappr_declineddate: $('#pnl_editapprovalform-txt_inquiryappr_declineddate'),
	txt_inquiryappr_notes: $('#pnl_editapprovalform-txt_inquiryappr_notes'),
	txt_inquiry_id: $('#pnl_editapprovalform-txt_inquiry_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_inquiryappr_id,
		autoid: true,
		logview: 'trn_inquiryappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.inquiry_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_inquiryappr_id

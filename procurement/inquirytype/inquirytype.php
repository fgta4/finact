...
if (is_file(__DIR__ .'/inquirytype.php-handler.php')) {
	require_once __DIR__ .'/inquirytype.php-handler.php';
}

/**
 * finact/procurement/inquirytype/inquirytype.php
 *
 * ===================================================================
 * Entry point Program Module inquirytype
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\inquirytype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new inquirytype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

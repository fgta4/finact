 ...
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel modeltransaksi inquirytype (mst_inquirytypetrxmodel)
...
$API = new class extends inquirytypeBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new inquirytype_modeltransaksiHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlFieldList = [
				'inquirytypetrxmodel_id' => 'A.`inquirytypetrxmodel_id`', 'trxmodel_id' => 'A.`trxmodel_id`', 'orderout_inquirytype_id' => 'A.`orderout_inquirytype_id`', 'inquirytype_id' => 'A.`inquirytype_id`',
				'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
			];
			$sqlFromTable = "mst_inquirytypetrxmodel A";
			$sqlWhere = $where->sql;
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('orderout_inquirytype_name', 'orderout_inquirytype_id', $record, 'mst_inquirytype', 'inquirytype_name', 'inquirytype_id');

...
/**
 * finact/procurement/inquirytype/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header inquirytype (mst_inquirytype)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['mst_inquirytypepartnertype', 'mst_inquirytypetrxmodel', 'mst_inquirytypeitemclass'];

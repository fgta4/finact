...
/**
 * finact/procurement/inquirytype/apis/modeltransaksi-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel modeltransaksi inquirytype (mst_inquirytypetrxmodel)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				// result
				$options->criteria = [
					"inquirytypetrxmodel_id" => $obj->inquirytypetrxmodel_id
				];

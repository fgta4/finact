...
/**
 * finact/procurement/inquirytype/apis/partnertype-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel partnertype inquirytype (mst_inquirytypepartnertype)
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('partnertype_name', 'partnertype_id', $record, 'mst_partnertype', 'partnertype_name', 'partnertype_id');

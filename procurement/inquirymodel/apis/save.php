...
/**
 * finact/procurement/inquirymodel/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header inquirymodel (mst_inquirymodel)
 *
...
$API = new class extends inquirymodelBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->inquirymodel_id = strtoupper($obj->inquirymodel_id);
			$obj->inquirymodel_name = strtoupper($obj->inquirymodel_name);
			...
			try {
				...
				// result
				$options->criteria = [
					"inquirymodel_id" => $obj->inquirymodel_id
				];

				$criteriaValues = [
					"inquirymodel_id" => " inquirymodel_id = :inquirymodel_id "
				];
				...
				$sqlFieldList = [
					'inquirymodel_id' => 'A.`inquirymodel_id`', 'inquirymodel_name' => 'A.`inquirymodel_name`', 'inquirymodel_descr' => 'A.`inquirymodel_descr`', 'trxmodel_id' => 'A.`trxmodel_id`',
					'inquirymodel_ispartnerheader' => 'A.`inquirymodel_ispartnerheader`', 'inquirymodel_isqtybreakdown' => 'A.`inquirymodel_isqtybreakdown`', 'inquirymodel_isdateinterval' => 'A.`inquirymodel_isdateinterval`', '_createby' => 'A.`_createby`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_inquirymodel A";
				$sqlWhere = $where->sql;

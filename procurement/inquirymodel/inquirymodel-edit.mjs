...
const obj = {
	...
	chk_inquirymodel_ispartnerheader: $('#pnl_edit-chk_inquirymodel_ispartnerheader'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_inquirymodel_id,
		autoid: false,
		logview: 'mst_inquirymodel',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.inquirymodel_ispartnerheader = '0'
...
function form_idsetup(options) {
	var objid = obj.txt_inquirymodel_id

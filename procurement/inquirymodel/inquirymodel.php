...
if (is_file(__DIR__ .'/inquirymodel.php-handler.php')) {
	require_once __DIR__ .'/inquirymodel.php-handler.php';
}

/**
 * finact/procurement/inquirymodel/inquirymodel.php
 *
 * ===================================================================
 * Entry point Program Module inquirymodel
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\inquirymodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new inquirymodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

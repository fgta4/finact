...
if (is_file(__DIR__ .'/budgetdeptalloc.php-handler.php')) {
	require_once __DIR__ .'/budgetdeptalloc.php-handler.php';
}

/**
 * finact/budget/budgetdeptalloc/budgetdeptalloc.php
 *
 * ===================================================================
 * Entry point Program Module budgetdeptalloc
 * ===================================================================
 ...
 * awal dibuat tanggal 15/01/2024
 * terakhir di generate tanggal 16/01/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\budgetdeptalloc_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new budgetdeptalloc_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

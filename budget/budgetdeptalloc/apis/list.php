...
/**
 * finact/budget/budgetdeptalloc/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header budgetdeptalloc (mst_budgetdeptalloc)
...
$API = new class extends budgetdeptallocBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.budgetdeptalloc_id LIKE CONCAT('%', :search, '%') "
			];
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('coabudget_dept_name', 'coabudget_id', $record, 'mst_coabudget', 'coabudget_name', 'coabudget_id');
				...
				$this->addFields('budgetdeptalloc_commitby', 'budgetdeptalloc_commitby', $record, $GLOBALS['MAIN_USERTABLE'], 'user_fullname', 'user_id');

...
/**
 * finact/budget/budgetdeptalloc/apis/source-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel source budgetdeptalloc (mst_budgetdeptallocsource)
...
$API = new class extends budgetdeptallocBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new budgetdeptalloc_sourceHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;

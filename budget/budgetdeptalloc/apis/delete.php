...
/**
 * finact/budget/budgetdeptalloc/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header budgetdeptalloc (mst_budgetdeptalloc)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['mst_budgetdeptallocsource', 'mst_budgetdeptallocsource'];

...
import * as hnd from  './budgetdeptalloc-edit-hnd.mjs'
...
const btn_apply = $('#pnl_edit-btn_apply')



const pnl_form = $('#pnl_edit-form')
const obj = {
	txt_budgetdeptalloc_id: $('#pnl_edit-txt_budgetdeptalloc_id'),
	txt_budgetdeptalloc_descr: $('#pnl_edit-txt_budgetdeptalloc_descr'),
	txt_budgetdeptalloc_year: $('#pnl_edit-txt_budgetdeptalloc_year'),
	cbo_coabudget_id: $('#pnl_edit-cbo_coabudget_id'),
	cbo_dept_id: $('#pnl_edit-cbo_dept_id'),
	txt_budgetdeptalloc_value: $('#pnl_edit-txt_budgetdeptalloc_value'),
	txt_budgetdeptalloc_apllied: $('#pnl_edit-txt_budgetdeptalloc_apllied'),
	cbo_owner_dept_id: $('#pnl_edit-cbo_owner_dept_id'),
	txt_budgetdeptalloc_version: $('#pnl_edit-txt_budgetdeptalloc_version'),
	chk_budgetdeptalloc_iscommit: $('#pnl_edit-chk_budgetdeptalloc_iscommit'),
	txt_budgetdeptalloc_commitby: $('#pnl_edit-txt_budgetdeptalloc_commitby'),
	txt_budgetdeptalloc_commitdate: $('#pnl_edit-txt_budgetdeptalloc_commitdate'),
	chk_budgetdeptalloc_isapply: $('#pnl_edit-chk_budgetdeptalloc_isapply')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_budgetdeptalloc_id,
		autoid: true,
		logview: 'mst_budgetdeptalloc',
	...
	btn_apply.linkbutton({ onClick: () => { 
		if (typeof hnd.btn_apply_click==='function') {
			hnd.btn_apply_click(); 
		} else {
			btn_action_click({ action: 'apply' }); 
		}
	} });
	...
	obj.cbo_coabudget_id.name = 'pnl_edit-cbo_coabudget_id'		
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.budgetdeptalloc_year = 0
		data.budgetdeptalloc_value = 0
		data.budgetdeptalloc_apllied = 0
		data.budgetdeptalloc_version = 0
		data.budgetdeptalloc_iscommit = '0'
		data.budgetdeptalloc_isapply = '0'
		...
		$ui.getPages().ITEMS['pnl_editsourcegrid'].handler.createnew(data, options)
...
function updaterecordstatus(record) {
	...
	rec_commitby.html(record.budgetdeptalloc_commitby);
	rec_commitdate.html(record.budgetdeptalloc_commitdate);
...
function updatebuttonstate(record) {
	...
	if (record.budgetdeptalloc_iscommit=="1") {
...
function updategridstate(record) {
	...
	var col_commit = 'budgetdeptalloc_iscommit';
	updategriddata[col_commit] = record.budgetdeptalloc_iscommit;	
...
function form_idsetup(options) {
	var objid = obj.txt_budgetdeptalloc_id
...
async function btn_action_click(args) {
	...
	var docname = 'Budget Dept Allocation'
	var txt_version = obj.txt_budgetdeptalloc_version;
	var chk_iscommit = obj.chk_budgetdeptalloc_iscommit;

...
if (is_file(__DIR__ .'/budgetdeptrev.php-handler.php')) {
	require_once __DIR__ .'/budgetdeptrev.php-handler.php';
}

/**
 * finact/budget/budgetdeptrev/budgetdeptrev.php
 *
 * ===================================================================
 * Entry point Program Module budgetdeptrev
 * ===================================================================
 ...
 * awal dibuat tanggal 14/01/2024
 * terakhir di generate tanggal 07/02/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\budgetdeptrev_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new budgetdeptrev_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

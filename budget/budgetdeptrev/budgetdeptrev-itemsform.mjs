...
import * as hnd from  './budgetdeptrev-itemsform-hnd.mjs'
...
const obj = {
	txt_budgetdeptrevitem_id: $('#pnl_edititemsform-txt_budgetdeptrevitem_id'),
	cbo_dept_id: $('#pnl_edititemsform-cbo_dept_id'),
	cbo_coabudget_id: $('#pnl_edititemsform-cbo_coabudget_id'),
	txt_budgetdeptmonth_year: $('#pnl_edititemsform-txt_budgetdeptmonth_year'),
	txt_budgetdeptmonth_month: $('#pnl_edititemsform-txt_budgetdeptmonth_month'),
	txt_budgetdeptmonth_value: $('#pnl_edititemsform-txt_budgetdeptmonth_value'),
	cbo_owner_dept_id: $('#pnl_edititemsform-cbo_owner_dept_id'),
	txt_budgetdeptrev_id: $('#pnl_edititemsform-txt_budgetdeptrev_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_budgetdeptrevitem_id,
		autoid: true,
		logview: 'mst_budgetdeptrevitem',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.cbo_dept_id.name = 'pnl_edititemsform-cbo_dept_id'		
	...
	obj.cbo_coabudget_id.name = 'pnl_edititemsform-cbo_coabudget_id'		
	...
	obj.cbo_owner_dept_id.name = 'pnl_edititemsform-cbo_owner_dept_id'		
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.budgetdeptrev_descr)
	if (typeof hnd!=='undefined') { 
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.budgetdeptrev_id = hdata.budgetdeptrev_id
		data.items_value = 0
...
function form_idsetup(options) {
	var objid = obj.txt_budgetdeptrevitem_id

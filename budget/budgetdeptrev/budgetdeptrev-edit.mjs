...
import * as hnd from  './budgetdeptrev-edit-hnd.mjs'
...
const obj = {
	txt_budgetdeptrev_id: $('#pnl_edit-txt_budgetdeptrev_id'),
	txt_budgetdeptyear_year: $('#pnl_edit-txt_budgetdeptyear_year'),
	cbo_coabudget_id: $('#pnl_edit-cbo_coabudget_id'),
	cbo_dept_id: $('#pnl_edit-cbo_dept_id'),
	txt_budgetdeptrev_descr: $('#pnl_edit-txt_budgetdeptrev_descr'),
	cbo_owner_dept_id: $('#pnl_edit-cbo_owner_dept_id'),
	txt_budgetdeptrev_version: $('#pnl_edit-txt_budgetdeptrev_version'),
	chk_budgetdeptrev_iscommit: $('#pnl_edit-chk_budgetdeptrev_iscommit'),
	txt_budgetdeptrev_commitby: $('#pnl_edit-txt_budgetdeptrev_commitby'),
	txt_budgetdeptrev_commitdate: $('#pnl_edit-txt_budgetdeptrev_commitdate'),
	chk_budgetdeptrev_isapprove: $('#pnl_edit-chk_budgetdeptrev_isapprove'),
	txt_budgetdeptrev_approveby: $('#pnl_edit-txt_budgetdeptrev_approveby'),
	txt_budgetdeptrev_approvedate: $('#pnl_edit-txt_budgetdeptrev_approvedate'),
	chk_budgetdeptrev_isapply: $('#pnl_edit-chk_budgetdeptrev_isapply')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_budgetdeptrev_id,
		autoid: true,
		logview: 'mst_budgetdeptrev',
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.budgetdeptyear_year = 0
		data.budgetdeptrev_version = 0
		data.budgetdeptrev_iscommit = '0'
		data.budgetdeptrev_isapprove = '0'
		data.budgetdeptrev_isapply = '0'
...
function updaterecordstatus(record) {
	...
	rec_commitby.html(record.budgetdeptrev_commitby);
	rec_commitdate.html(record.budgetdeptrev_commitdate);
...
function updatebuttonstate(record) {
	...
	if (record.budgetdeptrev_iscommit=="1") {
...
function updategridstate(record) {
	...
	var col_commit = 'budgetdeptrev_iscommit';
	updategriddata[col_commit] = record.budgetdeptrev_iscommit;	
...
function form_idsetup(options) {
	var objid = obj.txt_budgetdeptrev_id
...
async function btn_action_click(args) {
	...
	var docname = 'Budget Dept Revision'
	var txt_version = obj.txt_budgetdeptrev_version;
	var chk_iscommit = obj.chk_budgetdeptrev_iscommit;

...
/**
 * finact/budget/budgetdeptrev/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends budgetdeptrevBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			unset($obj->budgetdeptrev_iscommit);
			unset($obj->budgetdeptrev_commitby);
			unset($obj->budgetdeptrev_commitdate);
			unset($obj->budgetdeptrev_isapprove);
			unset($obj->budgetdeptrev_approveby);
			unset($obj->budgetdeptrev_approvedate);
			unset($obj->budgetdeptrev_isapply);
			...
			try {
				...
				// result
				$options->criteria = [
					"budgetdeptrev_id" => $obj->budgetdeptrev_id
				];

...
/**
 * finact/budget/budgetdeptrev/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header budgetdeptrev (mst_budgetdeptrev)
...
$API = new class extends budgetdeptrevBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.budgetdeptrev_id LIKE CONCAT('%', :search, '%') "
			];
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('budgetdeptrev_commitby', 'budgetdeptrev_commitby', $record, $GLOBALS['MAIN_USERTABLE'], 'user_fullname', 'user_id');
				$this->addFields('budgetdeptrev_approveby', 'budgetdeptrev_approveby', $record, $GLOBALS['MAIN_USERTABLE'], 'user_fullname', 'user_id');

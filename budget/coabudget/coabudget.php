...
if (is_file(__DIR__ .'/coabudget.php-handler.php')) {
	require_once __DIR__ .'/coabudget.php-handler.php';
}

/**
 * finact/budget/coabudget/coabudget.php
 *
 * ===================================================================
 * Entry point Program Module coabudget
 * ===================================================================
 ...
 * terakhir di generate tanggal 14/01/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\coabudget_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new coabudget_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

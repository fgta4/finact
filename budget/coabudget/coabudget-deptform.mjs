...
import * as hnd from  './coabudget-deptform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_editdeptform-caption')
...
const obj = {
	txt_coabudgetdept_id: $('#pnl_editdeptform-txt_coabudgetdept_id'),
	cbo_dept_id: $('#pnl_editdeptform-cbo_dept_id'),
	txt_coabudget_id: $('#pnl_editdeptform-txt_coabudget_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_coabudgetdept_id,
		autoid: true,
		logview: 'mst_coabudgetdept',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.coabudget_name)
	if (typeof hnd!=='undefined') { 
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.coabudget_id = hdata.coabudget_id
		data.dept_value = 0
...
function form_idsetup(options) {
	var objid = obj.txt_coabudgetdept_id

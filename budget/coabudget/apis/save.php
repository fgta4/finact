...
/**
 * finact/budget/coabudget/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header coabudget (mst_coabudget)
 *
...
$API = new class extends coabudgetBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->coabudget_name = strtoupper($obj->coabudget_name);
			...
			try {
				...
				// result
				$options->criteria = [
					"coabudget_id" => $obj->coabudget_id
				];

				$criteriaValues = [
					"coabudget_id" => " coabudget_id = :coabudget_id "
				];
				...
				$sqlFieldList = [
					'coabudget_id' => 'A.`coabudget_id`', 'coabudget_name' => 'A.`coabudget_name`', 'coabudget_isdisabled' => 'A.`coabudget_isdisabled`', 'coabudget_descr' => 'A.`coabudget_descr`',
					'owner_dept_id' => 'A.`owner_dept_id`', 'coa_id' => 'A.`coa_id`', '_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_coabudget A";
				$sqlWhere = $where->sql;

...
/**
 * finact/budget/coabudget/apis/dept-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel dept coabudget (mst_coabudgetdept)
 *
...
$API = new class extends coabudgetBase {
	...
	public function execute($data, $options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new coabudget_deptHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlUpdateField  = [
					'coabudgetdept_id', 'dept_id', 'coabudget_id'
			];
			...
			$obj->coabudget_id = strtoupper($obj->coabudget_id);
			...
			try {
				...
				// result
				$options->criteria = [
					"coabudgetdept_id" => $obj->coabudgetdept_id
				];

				$criteriaValues = [
					"coabudgetdept_id" => " coabudgetdept_id = :coabudgetdept_id "
				];
				...
				$sqlFieldList = [
					'coabudgetdept_id' => 'A.`coabudgetdept_id`', 'dept_id' => 'A.`dept_id`', 'coabudget_id' => 'A.`coabudget_id`', '_createby' => 'A.`_createby`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_coabudgetdept A";
				$sqlWhere = $where->sql;

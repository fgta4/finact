...
/**
 * finact/budget/coabudget/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header coabudget (mst_coabudget)
...
$API = new class extends coabudgetBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.coabudget_id LIKE CONCAT('%', :search, '%') OR A.coabudget_name LIKE CONCAT('%', :search, '%') "
			];

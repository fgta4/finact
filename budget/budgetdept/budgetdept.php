...
if (is_file(__DIR__ .'/budgetdept.php-handler.php')) {
	require_once __DIR__ .'/budgetdept.php-handler.php';
}

/**
 * finact/budget/budgetdept/budgetdept.php
 *
 * ===================================================================
 * Entry point Program Module budgetdept
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\budgetdept_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new budgetdept_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

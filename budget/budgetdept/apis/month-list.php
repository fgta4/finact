...
/**
 * finact/budget/budgetdept/apis/month-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel month budgetdept (mst_budgetdeptmonth)
...
$API = new class extends budgetdeptBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new budgetdept_monthHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;

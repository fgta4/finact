...
import * as hnd from  './budgetdept-edit-hnd.mjs'
...
const obj = {
	txt_budgetdeptyear_id: $('#pnl_edit-txt_budgetdeptyear_id'),
	...
	txt_budgetdeptyear_value: $('#pnl_edit-txt_budgetdeptyear_value'),
	cbo_owner_dept_id: $('#pnl_edit-cbo_owner_dept_id'),
	txt_budgetdeptprop_id: $('#pnl_edit-txt_budgetdeptprop_id'),
	txt_budgetdeptyear_version: $('#pnl_edit-txt_budgetdeptyear_version'),
	chk_budgetdeptyear_iscommit: $('#pnl_edit-chk_budgetdeptyear_iscommit'),
	txt_budgetdeptyear_commitby: $('#pnl_edit-txt_budgetdeptyear_commitby'),
	txt_budgetdeptyear_commitdate: $('#pnl_edit-txt_budgetdeptyear_commitdate'),
	chk_budgetdeptyear_isapprove: $('#pnl_edit-chk_budgetdeptyear_isapprove')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_budgetdeptyear_id,
		autoid: true,
		logview: 'mst_budgetdeptyear',
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.budgetdeptyear_value = 0
		data.budgetdeptyear_version = 0
		data.budgetdeptyear_iscommit = '0'
		data.budgetdeptyear_isapprove = '0'
		...
		$ui.getPages().ITEMS['pnl_editmonthgrid'].handler.createnew(data, options)
...
function updaterecordstatus(record) {
	...
	rec_commitby.html(record.budgetdeptyear_commitby);
	rec_commitdate.html(record.budgetdeptyear_commitdate);
...
function updategridstate(record) {
	...
	var col_commit = 'budgetdeptyear_iscommit';
	updategriddata[col_commit] = record.budgetdeptyear_iscommit;	
...
function form_idsetup(options) {
	var objid = obj.txt_budgetdeptyear_id
...
async function btn_action_click(args) {
	...
	var docname = 'Budget Dept'
	var txt_version = obj.txt_budgetdeptyear_version;
	var chk_iscommit = obj.chk_budgetdeptyear_iscommit;

...
if (is_file(__DIR__ .'/budgetdeptprop.php-handler.php')) {
	require_once __DIR__ .'/budgetdeptprop.php-handler.php';
}

/**
 * finact/budget/budgetdeptprop/budgetdeptprop.php
 *
 * ===================================================================
 * Entry point Program Module budgetdeptprop
 * ===================================================================
 ...
 * awal dibuat tanggal 25/01/2024
 * terakhir di generate tanggal 06/02/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\budgetdeptprop_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new budgetdeptprop_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

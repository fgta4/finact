...
/**
 * finact/budget/budgetdeptprop/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header budgetdeptprop (mst_budgetdeptprop)
...
$API = new class extends budgetdeptpropBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.budgetdeptprop_id LIKE CONCAT('%', :search, '%') OR A.budgetdeptprop_descr LIKE CONCAT('%', :search, '%') "
			];
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('budgetdeptprop_commitby', 'budgetdeptprop_commitby', $record, $GLOBALS['MAIN_USERTABLE'], 'user_fullname', 'user_id');
				$this->addFields('budgetdeptprop_generateby', 'budgetdeptprop_generateby', $record, $GLOBALS['MAIN_USERTABLE'], 'user_fullname', 'user_id');

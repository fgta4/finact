...
/**
 * finact/budget/budgetdeptprop/apis/item-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends budgetdeptpropBase {
	...
	public function execute($data, $options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new budgetdeptprop_itemHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlUpdateField  = [
					'budgetdeptpropitem_id', 'coabudget_id', 'dept_id', 'budgetdeptpropitem_descr',
					'budgetdeptmonth_01', 'budgetdeptmonth_02', 'budgetdeptmonth_03', 'budgetdeptmonth_04',
					'budgetdeptmonth_05', 'budgetdeptmonth_06', 'budgetdeptmonth_07', 'budgetdeptmonth_08',
					'budgetdeptmonth_09', 'budgetdeptmonth_10', 'budgetdeptmonth_11', 'budgetdeptmonth_12',
					'budgetdeptprop_id'
			];
			...
			try {
				...
				$detil_primarykey = 'budgetdeptprop_id';
				...
				// result
				$options->criteria = [
					"budgetdeptpropitem_id" => $obj->budgetdeptpropitem_id
				];

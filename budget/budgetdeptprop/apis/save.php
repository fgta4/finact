...
/**
 * finact/budget/budgetdeptprop/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends budgetdeptpropBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			unset($obj->budgetdeptprop_iscommit);
			unset($obj->budgetdeptprop_commitby);
			unset($obj->budgetdeptprop_commitdate);
			unset($obj->budgetdeptprop_isgenerate);
			unset($obj->budgetdeptprop_generateby);
			unset($obj->budgetdeptprop_generatedate);
			...
			try {
				...
				// result
				$options->criteria = [
					"budgetdeptprop_id" => $obj->budgetdeptprop_id
				];

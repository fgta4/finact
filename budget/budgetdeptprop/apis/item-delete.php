...
/**
 * finact/budget/budgetdeptprop/apis/item-delete.php
 *
 * ============
 * Detil-Delete
 * ============
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel item budgetdeptprop (mst_budgetdeptprop)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$header_table = 'mst_budgetdeptprop';
				$header_primarykey = 'budgetdeptprop_id';

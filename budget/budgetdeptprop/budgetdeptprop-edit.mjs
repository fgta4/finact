...
import * as hnd from  './budgetdeptprop-edit-hnd.mjs'
...
const obj = {
	...
	txt_budgetdeptprop_descr: $('#pnl_edit-txt_budgetdeptprop_descr'),
	txt_budgetdeptprop_year: $('#pnl_edit-txt_budgetdeptprop_year'),
	cbo_owner_dept_id: $('#pnl_edit-cbo_owner_dept_id'),
	txt_budgetdeptprop_version: $('#pnl_edit-txt_budgetdeptprop_version'),
	chk_budgetdeptprop_iscommit: $('#pnl_edit-chk_budgetdeptprop_iscommit'),
	txt_budgetdeptprop_commitby: $('#pnl_edit-txt_budgetdeptprop_commitby'),
	txt_budgetdeptprop_commitdate: $('#pnl_edit-txt_budgetdeptprop_commitdate'),
	chk_budgetdeptprop_isgenerate: $('#pnl_edit-chk_budgetdeptprop_isgenerate'),
	txt_budgetdeptprop_generateby: $('#pnl_edit-txt_budgetdeptprop_generateby'),
	txt_budgetdeptprop_generatedate: $('#pnl_edit-txt_budgetdeptprop_generatedate')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_budgetdeptprop_id,
		autoid: true,
		logview: 'mst_budgetdeptprop',
	...
	btn_generate.linkbutton({ onClick: () => { 
		if (typeof hnd.btn_generate_click==='function') {
			hnd.btn_generate_click(); 
		} else {
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.budgetdeptprop_year = 0
		data.budgetdeptprop_version = 0
		data.budgetdeptprop_iscommit = '0'
		data.budgetdeptprop_isgenerate = '0'
...
function updaterecordstatus(record) {
	...
	rec_commitby.html(record.budgetdeptprop_commitby);
	rec_commitdate.html(record.budgetdeptprop_commitdate);
...
function updategridstate(record) {
	...
	var col_commit = 'budgetdeptprop_iscommit';
	updategriddata[col_commit] = record.budgetdeptprop_iscommit;	
...
function form_idsetup(options) {
	var objid = obj.txt_budgetdeptprop_id
...
async function btn_action_click(args) {
	...
	var docname = 'Budget Dept Prop'
	var txt_version = obj.txt_budgetdeptprop_version;
	var chk_iscommit = obj.chk_budgetdeptprop_iscommit;

...
/**
 * finact/master/project/apis/dept-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel dept project (mst_project)
 *
...
$API = new class extends projectBase {
	...
	public function execute($data, $options) {
		$tablename = 'mst_projectdept';
		$primarykey = 'projectdept_id';
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'projectdept_id', 'dept_id', 'project_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

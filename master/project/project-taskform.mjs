...
const obj = {
	txt_projecttask_id: $('#pnl_edittaskform-txt_projecttask_id'),
	txt_projecttask_name: $('#pnl_edittaskform-txt_projecttask_name'),
	txt_projecttask_descr: $('#pnl_edittaskform-txt_projecttask_descr'),
	dt_projecttask_dtstart: $('#pnl_edittaskform-dt_projecttask_dtstart'),
	dt_projecttask_dtend: $('#pnl_edittaskform-dt_projecttask_dtend'),
	txt_dept_id: $('#pnl_edittaskform-txt_dept_id'),
	txt_project_id: $('#pnl_edittaskform-txt_project_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_projecttask_id,
		autoid: true,
		logview: 'mst_projecttask',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_projecttask_id

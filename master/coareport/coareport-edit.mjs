...
import * as hnd from  './coareport-edit-hnd.mjs'
...
const obj = {
	...
	txt_coareport_name: $('#pnl_edit-txt_coareport_name'),
	txt_coareport_descr: $('#pnl_edit-txt_coareport_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_coareport_id,
		autoid: false,
		logview: 'mst_coareport',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editcolumngrid'].handler.createnew(data, options)
...
function form_idsetup(options) {
	var objid = obj.txt_coareport_id

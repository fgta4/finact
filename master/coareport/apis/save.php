 ...
 * dari tabel header coareport (mst_coareport)
 *
...
$API = new class extends coareportBase {
	...
	public function execute($data, $options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new coareport_headerHandler($options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$obj->coareport_name = strtoupper($obj->coareport_name);
			...
			try {
				...
				// result
				$options->criteria = [
					"coareport_id" => $obj->coareport_id
				];

				$criteriaValues = [
					"coareport_id" => " coareport_id = :coareport_id "
				];
				...
				$sqlFieldList = [
					'coareport_id' => 'A.`coareport_id`', 'coareport_name' => 'A.`coareport_name`', 'coareport_descr' => 'A.`coareport_descr`', '_createby' => 'A.`_createby`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_coareport A";
				$sqlWhere = $where->sql;

...
/**
 * finact/master/coareport/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header coareport (mst_coareport)
...
$API = new class extends coareportBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.coareport_id LIKE CONCAT('%', :search, '%') OR A.coareport_name LIKE CONCAT('%', :search, '%') "
			];

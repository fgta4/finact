...
if (is_file(__DIR__ .'/coareport.php-handler.php')) {
	require_once __DIR__ .'/coareport.php-handler.php';
}

/**
 * finact/master/coareport/coareport.php
 *
 * ===================================================================
 * Entry point Program Module coareport
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\coareport_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new coareport_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

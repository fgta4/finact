...
const obj = {
	txt_coatype_id: $('#pnl_edit-txt_coatype_id'),
	txt_coatype_name: $('#pnl_edit-txt_coatype_name'),
	chk_coatype_isdisabled: $('#pnl_edit-chk_coatype_isdisabled'),
	txt_coatype_descr: $('#pnl_edit-txt_coatype_descr'),
	txt_coatype_order: $('#pnl_edit-txt_coatype_order'),
...
export function open(data, rowid, viewmode=true, fn_callback) {
	...
	var fn_dataopened = async (result, options) => {
		...
		form
			.fill(result.record)
			.setValue(obj.cbo_coareport_id, result.record.coareport_id, result.record.coareport_name)
			.commit()

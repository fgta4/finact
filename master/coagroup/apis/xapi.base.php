 ...
 * kelas ini harus di-inherit untuk semua api pada modul coagroup
 *
...
class coagroupBase extends WebAPI {
	...
	protected $main_tablename = "mst_coagroup";
	protected $main_primarykey = "coagroup_id";
	protected $main_field_version = "coagroup_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*coagroup*/.txt";
		// debug::disable();

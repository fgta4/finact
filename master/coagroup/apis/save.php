...
/**
 * finact/master/coagroup/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends coagroupBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->coagroup_name = strtoupper($obj->coagroup_name);
			$obj->coagroup_path = strtoupper($obj->coagroup_path);
			$obj->coagroup_pathid = strtoupper($obj->coagroup_pathid);
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'coagroup_id', 'coagroup_name', 'coagroup_descr', 'coagroup_isparent', 'coagroup_isdisabled', 'coagroup_parent', 'coamodel_id', 'coareport_id', 'coagroup_path', 'coagroup_pathid', 'coagroup_level', 'coagroup_isexselect', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

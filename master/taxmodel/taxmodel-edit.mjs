...
const obj = {
	txt_taxmodel_id: $('#pnl_edit-txt_taxmodel_id'),
	txt_taxmodel_name: $('#pnl_edit-txt_taxmodel_name'),
	txt_taxtmodel_descr: $('#pnl_edit-txt_taxtmodel_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_taxmodel_id,
		autoid: false,
		logview: 'mst_taxmodel',

...
if (is_file(__DIR__ .'/jurnaltype.php-handler.php')) {
	require_once __DIR__ .'/jurnaltype.php-handler.php';
}

/**
 * finact/master/jurnaltype/jurnaltype.php
 *
 * ===================================================================
 * Entry point Program Module jurnaltype
 * ===================================================================
 ...
 * terakhir di generate tanggal 23/11/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\jurnaltype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new jurnaltype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

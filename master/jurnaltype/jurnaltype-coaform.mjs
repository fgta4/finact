...
import * as hnd from  './jurnaltype-coaform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_editcoaform-caption')
const txt_title = $('#pnl_editcoaform-title')
const btn_edit = $('#pnl_editcoaform-btn_edit')
const btn_save = $('#pnl_editcoaform-btn_save')
const btn_delete = $('#pnl_editcoaform-btn_delete')
const btn_prev = $('#pnl_editcoaform-btn_prev')
const btn_next = $('#pnl_editcoaform-btn_next')
...
const obj = {
	...
	cbo_coa_id: $('#pnl_editcoaform-cbo_coa_id'),
	chk_jurnaltypecoa_isdebet: $('#pnl_editcoaform-chk_jurnaltypecoa_isdebet'),
	chk_jurnaltypecoa_iskredit: $('#pnl_editcoaform-chk_jurnaltypecoa_iskredit'),
	txt_jurnaltype_id: $('#pnl_editcoaform-txt_jurnaltype_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_jurnaltypecoa_id,
		autoid: true,
		logview: 'mst_jurnaltypecoa',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.cbo_coa_id.name = 'pnl_editcoaform-cbo_coa_id'		
			...
			if (form.isDataChanged()) {
				form.canceledit(()=>{
					$ui.getPages().show('pnl_editcoagrid', ()=>{
						form.setViewMode()
						$ui.getPages().ITEMS['pnl_editcoagrid'].handler.scrolllast()
					})					
				})
			} else {
				$ui.getPages().show('pnl_editcoagrid', ()=>{
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.jurnaltype_name)
	if (typeof hnd!=='undefined') { 
...
async function form_deleting(data, options) {
	options.api = `${global.modulefullname}/coa-delete`
...
function form_idsetup(options) {
	var objid = obj.txt_jurnaltypecoa_id

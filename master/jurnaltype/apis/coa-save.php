...
if (is_file(__DIR__ .'/data-coa-handler.php')) {
	require_once __DIR__ .'/data-coa-handler.php';
}
...
/**
 * finact/master/jurnaltype/apis/coa-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel coa jurnaltype (mst_jurnaltypecoa)
 *
...
$API = new class extends jurnaltypeBase {
	...
	public function execute($data, $options) {
		...
		$handlerclassname = "\\FGTA4\\apis\\jurnaltype_coaHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new jurnaltype_coaHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlUpdateField  = [
					'jurnaltypecoa_id', 'coa_id', 'jurnaltypecoa_isdebet', 'jurnaltypecoa_iskredit',
					'jurnaltype_id'
			];
			...
			$obj->jurnaltypecoa_id = strtoupper($obj->jurnaltypecoa_id);
			...
			try {
				...
				$header_table = 'mst_jurnaltype';
				$header_primarykey = 'jurnaltype_id';
				$detil_primarykey = 'jurnaltype_id';
				...
				// result
				$options->criteria = [
					"jurnaltypecoa_id" => $obj->jurnaltypecoa_id
				];
				...
				$sqlFieldList = [
					'jurnaltypecoa_id' => 'A.`jurnaltypecoa_id`', 'coa_id' => 'A.`coa_id`', 'jurnaltypecoa_isdebet' => 'A.`jurnaltypecoa_isdebet`', 'jurnaltypecoa_iskredit' => 'A.`jurnaltypecoa_iskredit`',
					'jurnaltype_id' => 'A.`jurnaltype_id`', '_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_jurnaltypecoa A";
				$sqlWhere = $where->sql;

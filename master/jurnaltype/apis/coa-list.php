...
/**
 * finact/master/jurnaltype/apis/coa-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel coa jurnaltype (mst_jurnaltypecoa)
...
$API = new class extends jurnaltypeBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new jurnaltype_coaHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;

...
if (is_file(__DIR__ .'/periodemo.php-handler.php')) {
	require_once __DIR__ .'/periodemo.php-handler.php';
}

/**
 * finact/master/periodemo/periodemo.php
 *
 * ===================================================================
 * Entry point Program Module periodemo
 * ===================================================================
 ...
 * terakhir di generate tanggal 15/09/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\periodemo_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new periodemo_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

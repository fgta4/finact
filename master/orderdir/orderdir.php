...
if (is_file(__DIR__ .'/orderdir.php-handler.php')) {
	require_once __DIR__ .'/orderdir.php-handler.php';
}

/**
 * finact/master/orderdir/orderdir.php
 *
 * ===================================================================
 * Entry point Program Module orderdir
 * ===================================================================
 ...
 * awal dibuat tanggal 26/07/2023
 * terakhir di generate tanggal 26/07/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\orderdir_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new orderdir_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

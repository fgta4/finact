...
/**
 * finact/master/orderdir/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header orderdir (mst_orderdir)
...
$API = new class extends orderdirBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.orderdir_id LIKE CONCAT('%', :search, '%') OR A.orderdir_name LIKE CONCAT('%', :search, '%') "
			];

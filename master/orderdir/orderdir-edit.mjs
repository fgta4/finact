...
import * as hnd from  './orderdir-edit-hnd.mjs'
...
const obj = {
	txt_orderdir_id: $('#pnl_edit-txt_orderdir_id'),
	txt_orderdir_name: $('#pnl_edit-txt_orderdir_name'),
	txt_orderdir_descr: $('#pnl_edit-txt_orderdir_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_orderdir_id,
		autoid: false,
		logview: 'mst_orderdir',

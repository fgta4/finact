...
import * as hnd from  './agingmodel-edit-hnd.mjs'
...
const obj = {
	txt_agingmodel_id: $('#pnl_edit-txt_agingmodel_id'),
	txt_agingmodel_name: $('#pnl_edit-txt_agingmodel_name'),
	txt_agingmodel_descr: $('#pnl_edit-txt_agingmodel_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_agingmodel_id,
		autoid: false,
		logview: 'mst_agingmodel',
...
function form_idsetup(options) {
	var objid = obj.txt_agingmodel_id

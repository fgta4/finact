...
if (is_file(__DIR__ .'/agingmodel.php-handler.php')) {
	require_once __DIR__ .'/agingmodel.php-handler.php';
}

/**
 * finact/master/agingmodel/agingmodel.php
 *
 * ===================================================================
 * Entry point Program Module agingmodel
 * ===================================================================
 ...
 * terakhir di generate tanggal 12/01/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\agingmodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new agingmodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

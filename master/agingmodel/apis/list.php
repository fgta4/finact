...
/**
 * finact/master/agingmodel/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header agingmodel (mst_agingmodel)
...
$API = new class extends agingmodelBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.agingmodel_id LIKE CONCAT('%', :search, '%') OR A.agingmodel_name LIKE CONCAT('%', :search, '%') "
			];

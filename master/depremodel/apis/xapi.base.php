 ...
 * kelas ini harus di-inherit untuk semua api pada modul depremodel
 *
...
class depremodelBase extends WebAPI {
	...
	protected $main_tablename = "mst_depremodel";
	protected $main_primarykey = "depremodel_id";
	protected $main_field_version = "depremodel_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*depremodel*/.txt";
		// debug::disable();

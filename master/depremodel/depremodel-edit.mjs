...
import * as hnd from  './depremodel-edit-hnd.mjs'
...
const obj = {
	txt_depremodel_id: $('#pnl_edit-txt_depremodel_id'),
	txt_depremodel_name: $('#pnl_edit-txt_depremodel_name'),
	txt_depremodel_descr: $('#pnl_edit-txt_depremodel_descr'),
	txt_depremodel_formulaname: $('#pnl_edit-txt_depremodel_formulaname'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_depremodel_id,
		autoid: false,
		logview: 'mst_depremodel',
...
function form_idsetup(options) {
	var objid = obj.txt_depremodel_id

...
if (is_file(__DIR__ .'/ordermodel.php-handler.php')) {
	require_once __DIR__ .'/ordermodel.php-handler.php';
}

/**
 * finact/master/ordermodel/ordermodel.php
 *
 * ===================================================================
 * Entry point Program Module ordermodel
 * ===================================================================
 ...
 * awal dibuat tanggal 27/07/2023
 * terakhir di generate tanggal 27/07/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\ordermodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new ordermodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

...
/**
 * finact/master/ordermodel/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header ordermodel (mst_ordermodel)
...
$API = new class extends ordermodelBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.ordermodel_id LIKE CONCAT('%', :search, '%') OR A.ordermodel_name LIKE CONCAT('%', :search, '%') "
			];
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('orderdir_name', 'orderdir_id', $record, 'mst_orderdir', 'orderdir_name', 'orderdir_id');

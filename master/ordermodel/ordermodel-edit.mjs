...
import * as hnd from  './ordermodel-edit-hnd.mjs'
...
const obj = {
	txt_ordermodel_id: $('#pnl_edit-txt_ordermodel_id'),
	txt_ordermodel_name: $('#pnl_edit-txt_ordermodel_name'),
	txt_ordermodel_descr: $('#pnl_edit-txt_ordermodel_descr'),
	cbo_orderdir_id: $('#pnl_edit-cbo_orderdir_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_ordermodel_id,
		autoid: false,
		logview: 'mst_ordermodel',
	...
	obj.cbo_orderdir_id.name = 'pnl_edit-cbo_orderdir_id'		
	new fgta4slideselect(obj.cbo_orderdir_id, {
		title: 'Pilih orderdir_id',
		returnpage: this_page_id,
		api: $ui.apis.load_orderdir_id,
		fieldValue: 'orderdir_id',
		fieldDisplay: 'orderdir_name',
		fields: [
			{mapping: 'orderdir_id', text: 'orderdir_id'},
			{mapping: 'orderdir_name', text: 'orderdir_name'}
		],
...
export function open(data, rowid, viewmode=true, fn_callback) {
	...
	var fn_dataopened = async (result, options) => {
		...
		*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_orderdir_id, record.orderdir_id, record.orderdir_name)
...
function form_idsetup(options) {
	var objid = obj.txt_ordermodel_id

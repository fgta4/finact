...
/**
 * finact/master/accfin/apis/coafilter-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel coafilter accfin (mst_accfin)
 *
...
$API = new class extends accfinBase {
	...
	public function execute($data, $options) {
		$tablename = 'mst_accfincoa';
		$primarykey = 'accfincoa_id';
		...
		try {
			...
			$obj->accfincoa_id = strtoupper($obj->accfincoa_id);
			...
			try {
				...
				$header_table = 'mst_accfin';
				$header_primarykey = 'accfin_id';
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'accfincoa_id', 'coa_id', 'accfin_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

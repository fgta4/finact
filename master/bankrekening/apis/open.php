...
class DataOpen extends WebAPI {
	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('mst_bankrekening', [
			...
			$result->record = array_merge($record, [
				'bankrekening_opendate' => date("d/m/Y", strtotime($record['bankrekening_opendate'])),
				'bankrekening_closedate' => date("d/m/Y", strtotime($record['bankrekening_closedate'])),

...
import * as hnd from  './accpettycash-edit-hnd.mjs'
...
const obj = {
	txt_accpettycash_id: $('#pnl_edit-txt_accpettycash_id'),
	txt_accpettycash_name: $('#pnl_edit-txt_accpettycash_name'),
	txt_accpettycash_descr: $('#pnl_edit-txt_accpettycash_descr'),
	chk_accpettycash_isdisabled: $('#pnl_edit-chk_accpettycash_isdisabled'),
	txt_accpettycash_io: $('#pnl_edit-txt_accpettycash_io'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_accpettycash_id,
		autoid: false,
		logview: 'mst_accpettycash',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.accpettycash_isdisabled = '0'
		data.accpettycash_io = 0
...
function form_idsetup(options) {
	var objid = obj.txt_accpettycash_id

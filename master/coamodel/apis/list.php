		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('coareport_name', 'coareport_id', $record, 'mst_coareport', 'coareport_name', 'coareport_id');
				$this->addFields('coareportcol_name', 'coareportcol_id', $record, 'mst_coareportcol', 'coareportcol_name', 'coareportcol_id');
				$this->addFields('agingmodel_name', 'agingmodel_id', $record, 'mst_agingmodel', 'agingmodel_name', 'agingmodel_id');

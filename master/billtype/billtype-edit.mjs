...
const obj = {
	txt_billtype_id: $('#pnl_edit-txt_billtype_id'),
	txt_billtype_name: $('#pnl_edit-txt_billtype_name'),
	txt_billtype_direction: $('#pnl_edit-txt_billtype_direction')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_billtype_id,
		autoid: false,
		logview: 'mst_billtype',

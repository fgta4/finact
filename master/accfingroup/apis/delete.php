...
/**
 * finact/master/accfingroup/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header accfingroup (mst_accfingroup)
 *
 ...
 * tanggal 17/08/2021
 */
$API = new class extends accfingroupBase {
	
	public function execute($data, $options) {
		$tablename = 'mst_accfingroup';
		$primarykey = 'accfingroup_id';

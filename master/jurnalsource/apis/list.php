...
/**
 * finact/master/jurnalsource/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header jurnalsource (mst_jurnalsource)
...
$API = new class extends jurnalsourceBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.jurnalsource_id LIKE CONCAT('%', :search, '%') OR A.jurnalsource_name LIKE CONCAT('%', :search, '%') "
			];

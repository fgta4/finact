...
/**
 * finact/master/jurnalsource/apis/jurnaltype-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends jurnalsourceBase {
	...
	public function execute($data, $options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new jurnalsource_jurnaltypeHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			try {
				...
				$header_table = 'mst_jurnalsource';
				$header_primarykey = 'jurnalsource_id';
				$detil_primarykey = 'jurnalsource_id';
				...
				// result
				$options->criteria = [
					"jurnalsourcetype_id" => $obj->jurnalsourcetype_id
				];

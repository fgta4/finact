...
if (is_file(__DIR__ .'/jurnalsource.php-handler.php')) {
	require_once __DIR__ .'/jurnalsource.php-handler.php';
}

/**
 * finact/master/jurnalsource/jurnalsource.php
 *
 * ===================================================================
 * Entry point Program Module jurnalsource
 * ===================================================================
 ...
 * terakhir di generate tanggal 15/08/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\jurnalsource_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new jurnalsource_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

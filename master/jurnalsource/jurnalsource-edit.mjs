...
import * as hnd from  './jurnalsource-edit-hnd.mjs'
...
const obj = {
	txt_jurnalsource_id: $('#pnl_edit-txt_jurnalsource_id'),
	txt_jurnalsource_name: $('#pnl_edit-txt_jurnalsource_name'),
	txt_jurnalsource_descr: $('#pnl_edit-txt_jurnalsource_descr'),
	chk_jurnalsource_isallowmanual: $('#pnl_edit-chk_jurnalsource_isallowmanual')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_jurnalsource_id,
		autoid: false,
		logview: 'mst_jurnalsource',
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.jurnalsource_isallowmanual = '0'
		...
		$ui.getPages().ITEMS['pnl_editjurnaltypegrid'].handler.createnew(data, options)
...
function form_idsetup(options) {
	var objid = obj.txt_jurnalsource_id

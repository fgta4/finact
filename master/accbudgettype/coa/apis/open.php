...
class DataOpen extends WebAPI {
	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('mst_coa', [
				'coa_id', 'coa_name', 'coa_isdisabled', 'coa_descr', 'coa_dk', 'coagroup_id', 'coamodel_id', 'coatype_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);

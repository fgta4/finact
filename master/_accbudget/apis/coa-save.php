...
/**
 * finact/master/accbudget/apis/coa-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel coa accbudget (mst_accbudget)
 *
...
$API = new class extends accbudgetBase {
	...
	public function execute($data, $options) {
		$tablename = 'mst_accbudgetcoa';
		$primarykey = 'accbudgetcoa_id';
		...
		try {
			...
			try {
				...
				$header_table = 'mst_accbudget';
				$header_primarykey = 'accbudget_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'accbudgetcoa_id', 'coa_id', 'accbudget_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);

...
const obj = {
	txt_accbudgetcoa_id: $('#pnl_editcoaform-txt_accbudgetcoa_id'),
	cbo_coa_id: $('#pnl_editcoaform-cbo_coa_id'),
	txt_accbudget_id: $('#pnl_editcoaform-txt_accbudget_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_accbudgetcoa_id,
		autoid: true,
		logview: 'mst_accbudgetcoa',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.accbudget_name)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.accbudget_id= hdata.accbudget_id
		data.coa_value = 0
...
function form_idsetup(options) {
	var objid = obj.txt_accbudgetcoa_id

...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->projecttaskempl_id = strtoupper($obj->projecttaskempl_id);
			$obj->role_id = strtoupper($obj->role_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'projecttaskempl_id', 'role_id', 'empl_id', 'projecttask_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
			...
			$result->dataresponse = (object) array_merge($dataresponse, [
				...
				'role_name' => \FGTA4\utils\SqlUtility::Lookup($data->role_id, $this->db, 'fgt_role', 'role_id', 'role_name'),

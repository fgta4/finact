...
import * as hnd from  './jurnalmodel-edit-hnd.mjs'
...
const obj = {
	txt_jurnalmodel_id: $('#pnl_edit-txt_jurnalmodel_id'),
	txt_jurnalmodel_name: $('#pnl_edit-txt_jurnalmodel_name'),
	chk_jurnalmodel_isdisabled: $('#pnl_edit-chk_jurnalmodel_isdisabled'),
	txt_jurnalmodel_descr: $('#pnl_edit-txt_jurnalmodel_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_jurnalmodel_id,
		autoid: false,
		logview: 'mst_jurnalmodel',
...
function form_idsetup(options) {
	var objid = obj.txt_jurnalmodel_id

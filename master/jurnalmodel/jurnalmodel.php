...
if (is_file(__DIR__ .'/jurnalmodel.php-handler.php')) {
	require_once __DIR__ .'/jurnalmodel.php-handler.php';
}

/**
 * finact/master/jurnalmodel/jurnalmodel.php
 *
 * ===================================================================
 * Entry point Program Module jurnalmodel
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\jurnalmodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new jurnalmodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

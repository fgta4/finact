...
const obj = {
	txt_projectmodel_id: $('#pnl_edit-txt_projectmodel_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_projectmodel_id,
		autoid: false,
		logview: 'mst_projectmodel',
	...
	new fgta4slideselect(obj.cbo_fg_accbudget_id, {
		...
		returnpage: this_page_id,
		api: $ui.apis.load_fg_accbudget_id,
		fieldValue: 'fg_accbudget_id',
	...
	new fgta4slideselect(obj.cbo_fg_coa_id, {
		title: 'Pilih fg_coa_id',
		returnpage: this_page_id,
		api: $ui.apis.load_fg_coa_id,
		fieldValue: 'fg_coa_id',
...
function form_idsetup(options) {
	var objid = obj.txt_projectmodel_id

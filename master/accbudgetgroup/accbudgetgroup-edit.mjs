...
export async function init(opt) {
	...
	new fgta4slideselect(obj.cbo_accbudgetgroup_parent, {
		...
		fieldValueMap: 'accbudgetgroup_parent',
		fieldDisplay: 'accbudgetgroup_parent_name',
		fields: [
			{mapping: 'accbudgetgroup_parent', text: 'ID'},
			{mapping: 'accbudgetgroup_parent_name', text: 'BudgetGroup Name'},
		],
		...
		OnDataLoaded : (result, options) => {
			...
			result.records.unshift({accbudgetgroup_parent:'--NULL--', accbudgetgroup_parent_name:'NONE'});	
		},
...
export function open(data, rowid, viewmode=true, fn_callback) {
	...
	var fn_dataopened = async (result, options) => {
		...
		*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_accbudgetgroup_parent, record.accbudgetgroup_parent, record.accbudgetgroup_parent_name)
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.accbudgetgroup_isparent = '0'
		data.accbudgetgroup_isdisabled = '0'
		data.accbudgetgroup_level = 0
		data.accbudgetgroup_isexselect = '0'

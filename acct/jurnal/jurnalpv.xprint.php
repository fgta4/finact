...
$MODULE = new class extends WebModule {
	...
	public function LoadPage($id, $variancename) {
		...
		try {
			...
			$this->DATA->partner_name = SqlUtility::Lookup($this->DATA->partner_id, $this->db, 'mst_partner', 'partner_id', 'partner_name');
			$this->DATA->user_fullname = SqlUtility::Lookup($this->DATA->_createby, $this->db, 'fgt_user', 'user_id', 'user_fullname');

...
/**
 * finact/acct/jurnal/apis/xapi.base.php
 *
 * jurnalBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul jurnal
 *
 ...
 * tanggal 30/11/2023
 */
class jurnalBase extends WebAPI {
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*jurnal*/.txt";
		// debug::disable();

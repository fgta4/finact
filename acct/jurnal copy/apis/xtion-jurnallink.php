	...
	public function execute($data) {
		...
		try {
			...
			try {
				...
				$jurnaldetil_id = $data->jurnaldetil_id;
				$jurnaldetil_id_ref = $data->jurnaldetil_id_ref;
				...
				SqlUtility::WriteLog($this->db, $this->reqinfo->modulefullname, $tablename, $jurnaldetil_id, 'LINK', $userdata->username, (object)[]);

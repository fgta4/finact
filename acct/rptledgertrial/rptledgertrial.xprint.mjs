...
function report_format_row(rpt, row, cellclass) {
	...
	var trialdebet_idr = parseFloat(row.trialdebet_idr).toLocaleString('en-US');
	var trialkredit_idr = parseFloat(row.trialkredit_idr).toLocaleString('en-US');
	var saldofinal_idr = parseFloat(row.saldofinal_idr).toLocaleString('en-US');
	...
	tr.innerHTML = `
		...
		<td class="${cellclass} col-amount" style="${style_amount}">${trialdebet_idr}</td>
		<td class="${cellclass} col-amount" style="${style_amount}">${trialkredit_idr}</td>
		<td class="${cellclass} col-amount" style="${style_amount}">${saldofinal_idr}</td>

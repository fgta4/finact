...
const txt_caption = $('#pnl_editsaldoform-caption')
...
const obj = {
	...
	txt_jurnaldetil_valfrg: $('#pnl_editsaldoform-txt_jurnaldetil_valfrg'),
	txt_jurnaldetil_validr: $('#pnl_editsaldoform-txt_jurnaldetil_validr'),
	txt_coamodel_id: $('#pnl_editsaldoform-txt_coamodel_id'),
	txt_coa_id: $('#pnl_editsaldoform-txt_coa_id'),
	txt_unit_id: $('#pnl_editsaldoform-txt_unit_id'),
	txt_dept_id: $('#pnl_editsaldoform-txt_dept_id'),
	txt_partner_id: $('#pnl_editsaldoform-txt_partner_id'),
	txt_project_id: $('#pnl_editsaldoform-txt_project_id'),
	txt_curr_id: $('#pnl_editsaldoform-txt_curr_id'),
	txt_saldoawal_frg: $('#pnl_editsaldoform-txt_saldoawal_frg'),
	txt_saldoawal_idr: $('#pnl_editsaldoform-txt_saldoawal_idr'),
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.periodemo_name)
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.saldoawal_frg = 0
		data.saldoawal_idr = 0

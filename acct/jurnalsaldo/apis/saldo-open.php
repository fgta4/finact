...
/**
 * finact/acct/jurnalsaldo/apis/saldo-open.php
 *
 * ==========
 * Detil-Open
 * ==========
	...
	public function execute($options) {
		...
		try {
			...
			$result->record = array_merge($record, [
				'jurnalsaldo_date' => date("d/m/Y", strtotime($record['jurnalsaldo_date'])),
				'jurnal_date' => date("d/m/Y", strtotime($record['jurnal_date'])),
				'jurnal_duedate' => date("d/m/Y", strtotime($record['jurnal_duedate'])),

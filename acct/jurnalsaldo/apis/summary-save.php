...
/**
 * finact/acct/jurnalsaldo/apis/summary-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends jurnalsaldoBase {
	...
	public function execute($data, $options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new jurnalsaldo_summaryHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlUpdateField  = [
					'jurnalsummary_id', 'coamodel_id', 'coa_id', 'unit_id',
					'dept_id', 'partner_id', 'project_id', 'curr_id',
					'saldoawal_frg', 'debet_frg', 'kredit_frg', 'saldoakhir_frg',
					'saldoawal_idr', 'debet_idr', 'kredit_idr', 'saldoakhir_idr',
					'periodemo_id'
			];
			...
			$obj->jurnalsummary_id = strtoupper($obj->jurnalsummary_id);
			...
			try {
				...
				// result
				$options->criteria = [
					"jurnalsummary_id" => $obj->jurnalsummary_id
				];

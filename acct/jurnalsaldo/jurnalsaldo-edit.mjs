...
import * as hnd from  './jurnalsaldo-edit-hnd.mjs'
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editsaldogrid'].handler.createnew(data, options)
		$ui.getPages().ITEMS['pnl_editsummarygrid'].handler.createnew(data, options)

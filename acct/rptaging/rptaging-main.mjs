...
function btn_load_click() {
	...
	var optiondata = cbo_reporttype.optiondata;
	var reportmodule = window.global.modulefullname + '/rptaging-f1.xprint?renderto=printtemplate.phtml&format=print-format-01-a4-landscape';

	if (optiondata.format=='f2') {
		reportmodule = window.global.modulefullname + '/rptaging-f2.xprint?renderto=printtemplate.phtml&format=print-format-01-a4-landscape';
	} else if (optiondata.format=='f3') {
		reportmodule = window.global.modulefullname + '/rptaging-f3.xprint?renderto=printtemplate.phtml&format=print-format-01-a4-landscape';
	}

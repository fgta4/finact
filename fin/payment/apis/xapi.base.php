...
/**
 * finact/fin/payment/apis/xapi.base.php
 *
 * paymentBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul payment
 *
 ...
 * tanggal 25/05/2021
 */
class paymentBase extends WebAPI {
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*payment*/.txt";
		// debug::disable();

...
/**
 * finact/fin/ofrecv/apis/response-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends ofrecvBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->jurnalresponse_id = strtoupper($obj->jurnalresponse_id);
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'jurnalresponse_id', 'jurnal_ref', 'jurnal_date', 'jurnal_descr', 'jurnal_validr', 'jurnal_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

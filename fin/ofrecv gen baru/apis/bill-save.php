...
/**
 * finact/fin/ofrecv/apis/bill-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel bill ofrecv (trn_jurnal)
 *
...
$API = new class extends ofrecvBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			// if ($obj->ref_jurnaldetil_id=='--NULL--') { unset($obj->ref_jurnaldetil_id); }
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'jurnaldetil_id', 'partner_id', 'temprecv_id', 'ref_jurnaldetil_id', 'jurnaldetil_descr', 'jurnaldetil_valfrg', 'curr_id', 'jurnaldetil_valfrgrate', 'jurnaldetil_validr', 'coa_id', 'dept_id', 'jurnal_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
				...
				'jurnaldetil_descr' => \FGTA4\utils\SqlUtility::Lookup($record['ref_jurnaldetil_id'], $this->db, 'trn_jurnaldetil', 'jurnaldetil_id', 'jurnaldetil_descr'),

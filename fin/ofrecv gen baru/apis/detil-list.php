 ...
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel detil ofrecv (trn_jurnal)
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.jurnaldetil_id, A.partner_id, A.jurnaldetil_id_ref, A.jurnaldetil_descr, A.jurnaldetil_valfrg, A.curr_id, A.jurnaldetil_valfrgrate, A.jurnaldetil_validr, A.coa_id, A.dept_id, A.jurnal_id, A._createby, A._createdate, A._modifyby, A._modifydate 

...
-- drop table if exists `trn_jurnalreferece`;
-- drop table if exists `trn_jurnalresponse`;
...
ALTER TABLE `trn_jurnal` ADD KEY `temprecv_id` (`temprecv_id`);
ALTER TABLE `trn_jurnal` ADD KEY `ar_jurnaldetil_id` (`ar_jurnaldetil_id`);
ALTER TABLE `trn_jurnal` ADD KEY `paymtype_id` (`paymtype_id`);
ALTER TABLE `trn_jurnal` ADD KEY `bankrekening_id` (`bankrekening_id`);
ALTER TABLE `trn_jurnal` ADD KEY `accfin_id` (`accfin_id`);
...
ALTER TABLE `trn_jurnal` ADD CONSTRAINT `fk_trn_jurnal_trn_temprecv` FOREIGN KEY (`temprecv_id`) REFERENCES `trn_temprecv` (`temprecv_id`);
ALTER TABLE `trn_jurnal` ADD CONSTRAINT `fk_trn_jurnal_trn_jurnaldetil` FOREIGN KEY (`ar_jurnaldetil_id`) REFERENCES `trn_jurnaldetil` (`jurnaldetil_id`);
ALTER TABLE `trn_jurnal` ADD CONSTRAINT `fk_trn_jurnal_mst_paymtype` FOREIGN KEY (`paymtype_id`) REFERENCES `mst_paymtype` (`paymtype_id`);
ALTER TABLE `trn_jurnal` ADD CONSTRAINT `fk_trn_jurnal_mst_bankrekening` FOREIGN KEY (`bankrekening_id`) REFERENCES `mst_bankrekening` (`bankrekening_id`);
ALTER TABLE `trn_jurnal` ADD CONSTRAINT `fk_trn_jurnal_mst_accfin` FOREIGN KEY (`accfin_id`) REFERENCES `mst_accfin` (`accfin_id`);

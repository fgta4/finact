...
const txt_title = $('#pnl_editrecvform-title')
const btn_edit = $('#pnl_editrecvform-btn_edit')
const btn_save = $('#pnl_editrecvform-btn_save')
const btn_delete = $('#pnl_editrecvform-btn_delete')
const btn_prev = $('#pnl_editrecvform-btn_prev')
const btn_next = $('#pnl_editrecvform-btn_next')
const btn_addnew = $('#pnl_editrecvform-btn_addnew')
const chk_autoadd = $('#pnl_editrecvform-autoadd')


const pnl_form = $('#pnl_editrecvform-form')
const obj = {
	txt_jurnaldetil_id: $('#pnl_editrecvform-txt_jurnaldetil_id'),
	cbo_partner_id: $('#pnl_editrecvform-cbo_partner_id'),
	cbo_jurnaldetil_id_ref: $('#pnl_editrecvform-cbo_jurnaldetil_id_ref'),
	txt_jurnaldetil_descr: $('#pnl_editrecvform-txt_jurnaldetil_descr'),
	txt_jurnaldetil_valfrg: $('#pnl_editrecvform-txt_jurnaldetil_valfrg'),
	cbo_curr_id: $('#pnl_editrecvform-cbo_curr_id'),
	txt_jurnaldetil_valfrgrate: $('#pnl_editrecvform-txt_jurnaldetil_valfrgrate'),
	txt_jurnaldetil_validr: $('#pnl_editrecvform-txt_jurnaldetil_validr'),
	cbo_coa_id: $('#pnl_editrecvform-cbo_coa_id'),
	cbo_dept_id: $('#pnl_editrecvform-cbo_dept_id'),
	txt_jurnal_id: $('#pnl_editrecvform-txt_jurnal_id')
}
...
export async function init(opt) {
	...
	obj.cbo_partner_id.name = 'pnl_editrecvform-cbo_partner_id'		
	...
	obj.cbo_jurnaldetil_id_ref.name = 'pnl_editrecvform-cbo_jurnaldetil_id_ref'		
	...
	obj.cbo_curr_id.name = 'pnl_editrecvform-cbo_curr_id'		
	...
	obj.cbo_coa_id.name = 'pnl_editrecvform-cbo_coa_id'		
	...
	obj.cbo_dept_id.name = 'pnl_editrecvform-cbo_dept_id'		
	...
	document.addEventListener('OnButtonBack', (ev) => {
		if ($ui.getPages().getCurrentPage()==this_page_id) {
			...
			if (form.isDataChanged()) {
				form.canceledit(()=>{
					$ui.getPages().show('pnl_editrecvgrid', ()=>{
						form.setViewMode()
						$ui.getPages().ITEMS['pnl_editrecvgrid'].handler.scrolllast()
					})					
				})
			} else {
				$ui.getPages().show('pnl_editrecvgrid', ()=>{
...
export function open(data, rowid, hdata) {
	...
	var fn_dataopening = async (options) => {
		options.api = `${global.modulefullname}/recv-open`
...
async function form_datasaving(data, options) {
	options.api = `${global.modulefullname}/recv-save`
...
async function form_datasaved(result, options) {
	...
	*/
	...
	form.rowid = $ui.getPages().ITEMS['pnl_editrecvgrid'].handler.updategrid(data, form.rowid)
...
async function form_deleting(data, options) {
	options.api = `${global.modulefullname}/recv-delete`
}

async function form_deleted(result, options) {
	options.suppressdialog = true
	$ui.getPages().show('pnl_editrecvgrid', ()=>{
		$ui.getPages().ITEMS['pnl_editrecvgrid'].handler.removerow(form.rowid)
	})
...
function btn_prev_click() {
	...
	var record = $ui.getPages().ITEMS['pnl_editrecvgrid'].handler.getGrid().DATA[dataid]

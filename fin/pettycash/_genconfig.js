	...
	persistent: {
		'trn_pettycash' : {
			...
			data: {
				...
				pettycash_amount: { text: 'Amount', type: dbtype.decimal(14, 2), null: false, default: 0, suppresslist: true },
				pettycash_value: { text: 'Value', type: dbtype.decimal(14, 2), null: false, default: 0, unset: true, suppresslist: false, hidden: true,  options:{disabled:true} },

				pettycash_version: {text:'Version', type: dbtype.int(4), null:false, default:'0', suppresslist: true, options:{disabled:true}},
				pettycash_iscommit: { text: 'Commit', type: dbtype.boolean, null: false, default: '0', unset:true, options: { disabled: true } },

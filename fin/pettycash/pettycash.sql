...
CREATE TABLE IF NOT EXISTS `trn_pettycash` (
	...
	`empl_id` varchar(30)  , 
	`cust_id` varchar(14)  , 
	`pettycash_amount` decimal(14, 2) NOT NULL DEFAULT 0, 
...
ALTER TABLE `trn_pettycash` ADD COLUMN IF NOT EXISTS  `pettycash_amount` decimal(14, 2) NOT NULL DEFAULT 0 AFTER `cust_id`;
ALTER TABLE `trn_pettycash` ADD COLUMN IF NOT EXISTS  `pettycash_value` decimal(14, 2) NOT NULL DEFAULT 0 AFTER `pettycash_amount`;
...
ALTER TABLE `trn_pettycash` MODIFY COLUMN IF EXISTS  `pettycash_amount` decimal(14, 2) NOT NULL DEFAULT 0 AFTER `cust_id`;
ALTER TABLE `trn_pettycash` MODIFY COLUMN IF EXISTS  `pettycash_value` decimal(14, 2) NOT NULL DEFAULT 0 AFTER `pettycash_amount`;

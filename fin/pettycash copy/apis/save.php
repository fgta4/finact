		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					  $primarykey
					, 'pettycash_id', 'pettycash_date', 'site_id', 'accpettycash_id', 'pettycash_descr', 'empl_id', 'cust_id', 'pettycash_value', 'pettycash_version', 'pettycash_iscommit', 'pettycash_commitby', 'pettycash_commitdate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

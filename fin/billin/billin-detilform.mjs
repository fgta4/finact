...
/*
		...
		if (record.projbudget_id==null) { record.projbudget_id='--NULL--'; record.projbudget_name='NONE'; }
		if (record.projbudgettask_id==null) { record.projbudgettask_id='--NULL--'; record.projecttask_name='NONE'; }
...
*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_rowitem_id, record.rowitem_id, record.rowtype_name)

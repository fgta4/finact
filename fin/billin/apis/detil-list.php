	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.billindetil_id, A.rowitem_id, A.taxtype_id, A.itemclass_id, A.projbudgetdet_id, A.billindetil_descr, A.billindetil_valfrg, A.curr_id, A.billindetil_valfrgrate, A.billindetil_validr, A.projbudget_id, A.projbudgettask_id, A.accbudget_id, A.coa_id, A.billin_id, A._createby, A._createdate, A._modifyby, A._modifydate 

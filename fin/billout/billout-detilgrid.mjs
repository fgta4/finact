...
import * as hnd from  './billout-detilgrid-hnd.mjs'
...
export function OpenDetil(data) {
	...
	var fn_listloaded = async (result, options) => {
		...
		setTimeout(()=>{
			var checkcolumns = document.querySelectorAll('#pnl_editdetilgrid-tbl_list .rowcheck');
			...
			var selectbutton = document.getElementById('pnl_editdetilgrid-tbl_list-selectall-button');
			if (detilform.AllowRemoveRecord) {

...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->billouttax_id = strtoupper($obj->billouttax_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'billouttax_id', 'billouttax_valfrg', 'billouttax_valfrgrate', 'billouttax_validr', 'coa_id', 'taxtype_id', 'curr_id', 'billout_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);

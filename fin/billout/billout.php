...
if (is_file(__DIR__ .'/billout.php-handler.php')) {
	require_once __DIR__ .'/billout.php-handler.php';
}

/**
 * finact/fin/billout/billout.php
 *
 * ===================================================================
 * Entry point Program Module billout
 * ===================================================================
 * Tagihan Keluar
 *
 * Create by:
 ...
 * awal dibuat tanggal 03/11/2023
 * terakhir di generate tanggal 16/05/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\billout_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new billout_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

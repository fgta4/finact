...
import * as hnd from  './billout-detilform-hnd.mjs'
...
const obj = {
	...
	txt_billoutdetil_value: $('#pnl_editdetilform-txt_billoutdetil_value'),
	cbo_curr_id: $('#pnl_editdetilform-cbo_curr_id'),
	txt_billoutdetil_frgrate: $('#pnl_editdetilform-txt_billoutdetil_frgrate'),
	txt_billoutdetil_valueidr: $('#pnl_editdetilform-txt_billoutdetil_valueidr'),
	txt_billoutdetil_ppnidr: $('#pnl_editdetilform-txt_billoutdetil_ppnidr'),
	txt_billoutdetil_dppidr: $('#pnl_editdetilform-txt_billoutdetil_dppidr'),
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(header_data.billout_descr)
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.billoutdetil_value = 0
		data.billoutdetil_frgrate = 0
		data.billoutdetil_valueidr = 0
		data.billoutdetil_ppnidr = 0
		data.billoutdetil_dppidr = 0
...
async function form_datasaving(data, options) {
	...
	// options.skipmappingresponse = ['itemclass_id', 'coa_id', ];

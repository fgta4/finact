...
/**
 * finact/fin/billoutrev/apis/detil-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends billoutrevBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->billoutdetil_bookdate = (\DateTime::createFromFormat('d/m/Y',$obj->billoutdetil_bookdate))->format('Y-m-d');
			...
			try {
				...
				$result->dataresponse = (object) array_merge($record, [
					...
					'billoutdetil_bookdate' => date("d/m/Y", strtotime($row['billoutdetil_bookdate'])),

...
/**
 * finact/fin/billoutrev/apis/detil-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel detil billoutrev (trn_billout)
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.billoutdetil_id, A.billrowtype_id, A.taxtype_id, A.billoutdetil_descr, A.curr_id, A.billoutdetil_valfrg, A.billoutdetil_valfrgrate, A.billoutdetil_validr, A.itemclass_id, A.coa_id, A.billoutdetil_validr_ori, A.billoutdetil_validr_rev, A.billoutdetil_validr_var, A.billoutdetil_rev_descr, A.rev_coa_id, A.periodemo_id, A.billoutdetil_bookdate, A.billout_id, A._createby, A._createdate, A._modifyby, A._modifydate 

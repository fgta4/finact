...
const obj = {
	...
	txt_billoutdetil_validr_ori: $('#pnl_editdetilform-txt_billoutdetil_validr_ori'),
	txt_billoutdetil_validr_rev: $('#pnl_editdetilform-txt_billoutdetil_validr_rev'),
	txt_billoutdetil_validr_var: $('#pnl_editdetilform-txt_billoutdetil_validr_var'),
	txt_billoutdetil_rev_descr: $('#pnl_editdetilform-txt_billoutdetil_rev_descr'),
	cbo_rev_coa_id: $('#pnl_editdetilform-cbo_rev_coa_id'),
	cbo_periodemo_id: $('#pnl_editdetilform-cbo_periodemo_id'),
	dt_billoutdetil_bookdate: $('#pnl_editdetilform-dt_billoutdetil_bookdate'),
...
export async function init(opt) {
	...
	obj.txt_billoutdetil_validr_rev.numberbox({ onChange: (newvalue, oldvalue) => { txt_billoutdetil_validr_valuechanged(newvalue, oldvalue); } })
	...
	obj.cbo_rev_coa_id.name = 'pnl_editdetilform-cbo_rev_coa_id'		
	new fgta4slideselect(obj.cbo_rev_coa_id, {
		title: 'Pilih rev_coa_id',
		returnpage: this_page_id,
		api: $ui.apis.load_rev_coa_id,
		fieldValue: 'rev_coa_id',
		fieldValueMap: 'coa_id',
		fieldDisplay: 'coa_name',
		fields: [
			{mapping: 'coa_id', text: 'coa_id'},
	...
	obj.cbo_periodemo_id.name = 'pnl_editdetilform-cbo_periodemo_id'		
...
/*
		...
		if (record.rev_coa_id==null) { record.rev_coa_id='--NULL--'; record.rev_coa_name='NONE'; }
...
*/
		...
		form
			...
			.setValue(obj.cbo_rev_coa_id, record.rev_coa_id, record.rev_coa_name)
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.billoutdetil_validr_ori = 0
		data.billoutdetil_validr_rev = 0
		data.billoutdetil_validr_var = 0
		data.billoutdetil_bookdate = global.now()
		...
		data.coa_id = '--NULL--'
		data.coa_name = 'NONE'
		data.rev_coa_id = '--NULL--'
		data.rev_coa_name = 'NONE'
		data.periodemo_id = '0'
...
async function form_datasaving(data, options) {
	...
	// options.skipmappingresponse = ['taxtype_id', 'coa_id', 'rev_coa_id', ];
...
async function form_datasaved(result, options) {
	...
	form.setValue(obj.cbo_rev_coa_id, result.dataresponse.rev_coa_name!=='--NULL--' ? result.dataresponse.rev_coa_id : '--NULL--', result.dataresponse.rev_coa_name!=='--NULL--'?result.dataresponse.rev_coa_name:'NONE')
...
function txt_billoutdetil_validr_valuechanged(o, n) {
	if (form.isEventSuspended()) {
		return;
	}

	var tagihanawal =  parseFloat(obj.txt_billoutdetil_validr_ori.numberbox('getValue'));
	var tagihanbaru =  parseFloat(obj.txt_billoutdetil_validr_rev.numberbox('getValue'));

	var variance = tagihanbaru - tagihanawal;
	form.setValue(obj.txt_billoutdetil_validr_var, variance)

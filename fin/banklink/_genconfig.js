	...
	persistent: {
		...
		'trn_bankbookdetil' : {
			...
			data: {
				...
				jurnal_id: {
					text:'Jurnal', type: dbtype.varchar(20), null:true, suppresslist: true,
					options:{prompt:'NONE'},
					comp: comp.Combo({
						table: 'trn_jurnal', 
						field_value: 'jurnal_id', field_display: 'jurnal_descr', field_display_name: 'jurnal_descr',
						api: 'finact/acct/jurnal/list-forbanklink'})
				},

				acc_fin: {
					text:'Account Finance', type: dbtype.varchar(20), null:true, suppresslist: true,
					options:{prompt:'NONE'},
					comp: comp.Combo({
						table: 'mst_accfin', 
						field_value: 'accfin_id', field_display: 'accfin_name', field_display_name: 'accfin_name',

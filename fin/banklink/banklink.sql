...
ALTER TABLE `trn_bankbookdetil` ADD KEY `jurnal_id` (`jurnal_id`);
ALTER TABLE `trn_bankbookdetil` ADD KEY `acc_fin` (`acc_fin`);
ALTER TABLE `trn_bankbookdetil` ADD KEY `bankbook_id` (`bankbook_id`);

ALTER TABLE `trn_bankbookdetil` ADD CONSTRAINT `fk_trn_bankbookdetil_trn_jurnal` FOREIGN KEY (`jurnal_id`) REFERENCES `trn_jurnal` (`jurnal_id`);
ALTER TABLE `trn_bankbookdetil` ADD CONSTRAINT `fk_trn_bankbookdetil_mst_accfin` FOREIGN KEY (`acc_fin`) REFERENCES `mst_accfin` (`accfin_id`);

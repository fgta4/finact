...
const obj = {
	txt_paymentscdappr_id: $('#pnl_editapprovalform-txt_paymentscdappr_id'),
	chk_paymentscdappr_isapproved: $('#pnl_editapprovalform-chk_paymentscdappr_isapproved'),
	txt_paymentscdappr_by: $('#pnl_editapprovalform-txt_paymentscdappr_by'),
	txt_paymentscdappr_date: $('#pnl_editapprovalform-txt_paymentscdappr_date'),
	txt_paymentscd_version: $('#pnl_editapprovalform-txt_paymentscd_version'),
	chk_paymentscdappr_isdeclined: $('#pnl_editapprovalform-chk_paymentscdappr_isdeclined'),
	txt_paymentscdappr_declinedby: $('#pnl_editapprovalform-txt_paymentscdappr_declinedby'),
	txt_paymentscdappr_declineddate: $('#pnl_editapprovalform-txt_paymentscdappr_declineddate'),
	txt_paymentscdappr_notes: $('#pnl_editapprovalform-txt_paymentscdappr_notes'),
	txt_paymentscd_id: $('#pnl_editapprovalform-txt_paymentscd_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_paymentscdappr_id,
		autoid: true,
		logview: 'trn_paymentscdappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.paymentscd_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_paymentscdappr_id

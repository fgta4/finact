...
$API = new class extends ofrecvBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->paym_girodate = (\DateTime::createFromFormat('d/m/Y',$obj->paym_girodate))->format('Y-m-d');



			if ($obj->jurnal_ref=='') { $obj->jurnal_ref = '--NULL--'; }
			if ($obj->paym_gironum=='') { $obj->paym_gironum = '--NULL--'; }


			unset($obj->tjurnalor_iscommit);
			unset($obj->tjurnalor_commitby);
			unset($obj->tjurnalor_commitdate);
			unset($obj->tjurnalor_ispost);
			unset($obj->tjurnalor_postby);
			unset($obj->tjurnalor_postdate);

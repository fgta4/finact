...
import * as hnd from  './pettycashsaldo-edit-hnd.mjs'
...
const obj = {
	txt_pettycashsaldo_id: $('#pnl_edit-txt_pettycashsaldo_id'),
	dt_pettycashsaldo_date: $('#pnl_edit-dt_pettycashsaldo_date'),
	cbo_site_id: $('#pnl_edit-cbo_site_id'),
	txt_pettycashsaldo_awal: $('#pnl_edit-txt_pettycashsaldo_awal'),
	txt_pettycashsaldo_mutasi: $('#pnl_edit-txt_pettycashsaldo_mutasi'),
	txt_pettycashsaldo_akhir: $('#pnl_edit-txt_pettycashsaldo_akhir'),
	chk_pettycashsaldo_isclosed: $('#pnl_edit-chk_pettycashsaldo_isclosed')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_pettycashsaldo_id,
		autoid: true,
		logview: 'trn_pettycashsaldo',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.pettycashsaldo_date = global.now()
		data.pettycashsaldo_awal = 0
		data.pettycashsaldo_mutasi = 0
		data.pettycashsaldo_akhir = 0
		data.pettycashsaldo_isclosed = '0'
...
function form_idsetup(options) {
	var objid = obj.txt_pettycashsaldo_id

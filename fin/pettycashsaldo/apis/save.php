...
/**
 * finact/fin/pettycashsaldo/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends pettycashsaldoBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->pettycashsaldo_date = (\DateTime::createFromFormat('d/m/Y',$obj->pettycashsaldo_date))->format('Y-m-d');





			unset($obj->pettycashsaldo_isclosed);
			...
			try {
				...
				$result->dataresponse = (object) array_merge($record, [
					...
					'pettycashsaldo_date' => date("d/m/Y", strtotime($row['pettycashsaldo_date'])),

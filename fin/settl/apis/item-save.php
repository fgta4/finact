...
/**
 * finact/fin/settl/apis/item-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel item settl (trn_settl)
 *
...
$API = new class extends settlBase {
	...
	public function execute($data, $options) {
		$tablename = 'trn_settlitem';
		$primarykey = 'settlitem_id';
		...
		try {
			...
			$obj->settlitem_id = strtoupper($obj->settlitem_id);
			...
			try {
				...
				$header_table = 'trn_settl';
				$header_primarykey = 'settl_id';
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'settlitem_id', 'itemasset_id', 'item_id', 'itemstock_id', 'partner_id', 'itemclass_id', 'settlitem_descr', 'settlitem_qty', 'settlitem_days', 'settlitem_task', 'settlitem_rate', 'settlitem_value', 'curr_id', 'settlitem_currrate', 'settlitem_idr', 'accbudget_id', 'coa_id', 'settl_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

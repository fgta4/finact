...
const obj = {
	txt_settlappr_id: $('#pnl_editapprovalform-txt_settlappr_id'),
	chk_settlappr_isapproved: $('#pnl_editapprovalform-chk_settlappr_isapproved'),
	txt_settlappr_by: $('#pnl_editapprovalform-txt_settlappr_by'),
	txt_settlappr_date: $('#pnl_editapprovalform-txt_settlappr_date'),
	txt_settl_version: $('#pnl_editapprovalform-txt_settl_version'),
	chk_settlappr_isdeclined: $('#pnl_editapprovalform-chk_settlappr_isdeclined'),
	txt_settlappr_declinedby: $('#pnl_editapprovalform-txt_settlappr_declinedby'),
	txt_settlappr_declineddate: $('#pnl_editapprovalform-txt_settlappr_declineddate'),
	txt_settlappr_notes: $('#pnl_editapprovalform-txt_settlappr_notes'),
	txt_settl_id: $('#pnl_editapprovalform-txt_settl_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_settlappr_id,
		autoid: true,
		logview: 'trn_settlappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_settlappr_id

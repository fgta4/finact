...
const obj = {
	...
	dt_bankbook_date: $('#pnl_edit-dt_bankbook_date'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_bankbook_id,
		autoid: true,
		logview: 'trn_bankbook',
...
function btn_print_click() {
	...
	var printurl = 'index.php/printout/' + window.global.modulefullname + '/bankbook.xprint?id=' + id;

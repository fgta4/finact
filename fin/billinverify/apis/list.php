...
/**
 * finact/fin/billinverify/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header billinverify (trn_billin)

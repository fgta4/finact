...
/**
 * finact/fin/billinverify/apis/xapi.base.php
 *
 * billinverifyBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul billinverify
 *
 ...
 * tanggal 30/05/2021
 */
class billinverifyBase extends WebAPI {
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*billinverify*/.txt";
		// debug::disable();

...
/**
 * finact/fin/billinverify/apis/paym-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel paym billinverify (trn_billin)
 *
		...
		try {
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'billinpaym_id', 'billinpaym_date', 'billinpaym_descr', 'curr_id', 'billinpaym_frgrate', 'billinpaym_itemfrg', 'billinpaym_itemidr', 'billinpaym_ppnfrg', 'billinpaym_ppnidr', 'billinpaym_pphfrg', 'billinpaym_pphidr', 'billin_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);

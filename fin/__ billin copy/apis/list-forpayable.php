		...
		try {
			...
			foreach ($rows as $row) {
				...
				array_push($records, array_merge($record, [
					...
					'billin_date_dt' => date("d/m/Y", strtotime($record['billin_date'])),
					'billin_datedue_dt' => date("d/m/Y", strtotime($record['billin_datedue'])),
				 	//'tambahan' => 'dta'
					...
					'projbudgettask_name' => \FGTA4\utils\SqlUtility::Lookup($record['projbudgettask_id'], $this->db, 'mst_projecttask', 'projecttask_id', 'projecttask_name'),

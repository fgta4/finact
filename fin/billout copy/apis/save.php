...
$API = new class extends billoutBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->billout_date = (\DateTime::createFromFormat('d/m/Y',$obj->billout_date))->format('Y-m-d');			$obj->billout_datedue = (\DateTime::createFromFormat('d/m/Y',$obj->billout_datedue))->format('Y-m-d');
			$obj->billout_id = strtoupper($obj->billout_id);


			// if ($obj->dept_id=='--NULL--') { unset($obj->dept_id); }
			// if ($obj->salesorder_id=='--NULL--') { unset($obj->salesorder_id); }

...
const obj = {
	txt_itemspec_id: $('#pnl_edit-txt_itemspec_id'),
	txt_itemspec_name: $('#pnl_edit-txt_itemspec_name'),
	txt_itemspec_descr: $('#pnl_edit-txt_itemspec_descr'),
	chk_itemspec_isnumber: $('#pnl_edit-chk_itemspec_isnumber')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemspec_id,
		autoid: false,
		logview: 'mst_itemspec',

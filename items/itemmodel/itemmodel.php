...
if (is_file(__DIR__ .'/itemmodel.php-handler.php')) {
	require_once __DIR__ .'/itemmodel.php-handler.php';
}

/**
 * finact/items/itemmodel/itemmodel.php
 *
 * ===================================================================
 * Entry point Program Module itemmodel
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\itemmodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemmodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

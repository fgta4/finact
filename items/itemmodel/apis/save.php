...
/**
 * finact/items/itemmodel/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header itemmodel (mst_itemmodel)
 *
...
$API = new class extends itemmodelBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->itemmodel_name = strtoupper($obj->itemmodel_name);
			...
			try {
				...
				// result
				$options->criteria = [
					"itemmodel_id" => $obj->itemmodel_id
				];

				$criteriaValues = [
					"itemmodel_id" => " itemmodel_id = :itemmodel_id "
				];

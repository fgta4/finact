...
const obj = {
	txt_itemmodel_id: $('#pnl_edit-txt_itemmodel_id'),
	txt_itemmodel_name: $('#pnl_edit-txt_itemmodel_name'),
	txt_itemmodel_descr: $('#pnl_edit-txt_itemmodel_descr'),
...
function form_idsetup(options) {
	var objid = obj.txt_itemmodel_id

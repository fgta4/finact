...
import * as hnd from  './itemctg-edit-hnd.mjs'
...
const obj = {
	txt_itemctg_id: $('#pnl_edit-txt_itemctg_id'),
	txt_itemctg_name: $('#pnl_edit-txt_itemctg_name'),
	txt_itemctg_group: $('#pnl_edit-txt_itemctg_group'),

...
const obj = {
	txt_itemmovedetil_id: $('#pnl_editdetilform-txt_itemmovedetil_id'),
	txt_item_id: $('#pnl_editdetilform-txt_item_id'),
	txt_item_name: $('#pnl_editdetilform-txt_item_name'),
	txt_itemmovedetil_qtyprop: $('#pnl_editdetilform-txt_itemmovedetil_qtyprop'),
	txt_itemmovedetil_qtysend: $('#pnl_editdetilform-txt_itemmovedetil_qtysend'),
	txt_itemmovedetil_qtyrecv: $('#pnl_editdetilform-txt_itemmovedetil_qtyrecv'),
	txt_itemmove_id: $('#pnl_editdetilform-txt_itemmove_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemmovedetil_id,
		autoid: true,
		logview: 'trn_itemmovedetil',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.itemmove_descr)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.itemmove_id= hdata.itemmove_id
		data.detil_value = 0

		data.itemmovedetil_qtyprop = 0
		data.itemmovedetil_qtysend = 0
		data.itemmovedetil_qtyrecv = 0
...
function form_idsetup(options) {
	var objid = obj.txt_itemmovedetil_id

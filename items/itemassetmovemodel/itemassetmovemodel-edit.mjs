...
import * as hnd from  './itemassetmovemodel-edit-hnd.mjs'
...
const obj = {
	txt_itemassetmovemodel_id: $('#pnl_edit-txt_itemassetmovemodel_id'),
	txt_itemassetmovemodel_name: $('#pnl_edit-txt_itemassetmovemodel_name'),
	txt_itemassetmovemodel_descr: $('#pnl_edit-txt_itemassetmovemodel_descr'),
	cbo_inquirymodel_id: $('#pnl_edit-cbo_inquirymodel_id'),
	cbo_trxmodel_id: $('#pnl_edit-cbo_trxmodel_id'),
	chk_itemassetmovemodel_isdateinterval: $('#pnl_edit-chk_itemassetmovemodel_isdateinterval'),
	chk_itemassetmovemodel_isdept: $('#pnl_edit-chk_itemassetmovemodel_isdept'),
	chk_itemassetmovemodel_isemployee: $('#pnl_edit-chk_itemassetmovemodel_isemployee'),
	chk_itemassetmovemodel_issite: $('#pnl_edit-chk_itemassetmovemodel_issite'),
	chk_itemassetmovemodel_isroom: $('#pnl_edit-chk_itemassetmovemodel_isroom')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemassetmovemodel_id,
		autoid: false,
		logview: 'mst_itemassetmovemodel',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.itemassetmovemodel_isdateinterval = '0'
		data.itemassetmovemodel_isdept = '0'
		data.itemassetmovemodel_isemployee = '0'
		data.itemassetmovemodel_issite = '0'
		data.itemassetmovemodel_isroom = '0'
...
function form_idsetup(options) {
	var objid = obj.txt_itemassetmovemodel_id

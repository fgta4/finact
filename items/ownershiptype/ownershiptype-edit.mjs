...
const obj = {
	txt_ownershiptype_id: $('#pnl_edit-txt_ownershiptype_id'),
	txt_ownershiptype_name: $('#pnl_edit-txt_ownershiptype_name'),
	txt_ownershiptype_descr: $('#pnl_edit-txt_ownershiptype_descr'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_ownershiptype_id,
		autoid: false,
		logview: 'mst_ownershiptype',
...
function form_idsetup(options) {
	var objid = obj.txt_ownershiptype_id

...
/**
 * finact/items/itemassetmove/apis/items-delete.php
 *
 * ============
 * Detil-Delete
 * ============
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel items itemassetmove (trn_itemassetmove)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$header_table = 'trn_itemassetmove';
				$header_primarykey = 'itemassetmove_id';

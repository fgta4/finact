	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				...
				, A.deliver_city, A.deliver_upname, A.deliver_uptelp, A.inquirymodel_id, A.inquiryselect_id, A.owner_dept_id, A.request_doc_id
				...
				, M.itemassetmovemodel_id, M.itemassetmovemodel_name 
				from trn_inquiry A
				left join mst_itemassetmovemodel M on M.inquirymodel_id = A.inquirymodel_id
			" 
			. $where->sql 
			. " order by A.inquiry_id desc "
			. $limit);
			$stmt->execute($where->params);

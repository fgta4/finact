...
/**
 * finact/items/itemassetmove/apis/xapi.base.php
 *
 * itemassetmoveBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul itemassetmove
 *
...
class itemassetmoveBase extends WebAPI {
	...
	protected $main_tablename = "trn_itemassetmove";
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*itemassetmove*/.txt";
		// debug::disable();

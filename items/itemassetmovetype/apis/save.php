...
/**
 * finact/items/itemassetmovetype/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends itemassetmovetypeBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->itemassetmovetype_id = strtoupper($obj->itemassetmovetype_id);
			$obj->itemassetmovetype_name = strtoupper($obj->itemassetmovetype_name);
			$obj->itemassetmovemodel_id = strtoupper($obj->itemassetmovemodel_id);

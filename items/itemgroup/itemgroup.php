...
if (is_file(__DIR__ .'/itemgroup.php-handler.php')) {
	require_once __DIR__ .'/itemgroup.php-handler.php';
}

/**
 * finact/items/itemgroup/itemgroup.php
 *
 * ===================================================================
 * Entry point Program Module itemgroup
 * ===================================================================
 ...
 * terakhir di generate tanggal 24/08/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\itemgroup_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemgroup_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

...
/**
 * finact/items/itemgroup/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends itemgroupBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->itemgroup_id = strtoupper($obj->itemgroup_id);
			$obj->itemgroup_name = strtoupper($obj->itemgroup_name);


			if ($obj->itemgroup_descr=='') { $obj->itemgroup_descr = '--NULL--'; }
			if ($obj->itemgroup_path=='') { $obj->itemgroup_path = '--NULL--'; }

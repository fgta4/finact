...
ALTER TABLE `mst_itemgroup` ADD COLUMN IF NOT EXISTS  `itemgroup_isparent` tinyint(1) NOT NULL DEFAULT 0 AFTER `itemgroup_descr`;
ALTER TABLE `mst_itemgroup` ADD COLUMN IF NOT EXISTS  `itemgroup_parent` varchar(17)   AFTER `itemgroup_isparent`;
ALTER TABLE `mst_itemgroup` ADD COLUMN IF NOT EXISTS  `itemgroup_pathid` varchar(17) NOT NULL  AFTER `itemgroup_parent`;
...
ALTER TABLE `mst_itemgroup` ADD COLUMN IF NOT EXISTS  `itemgroup_isexselect` tinyint(1) NOT NULL DEFAULT 0 AFTER `itemgroup_level`;
ALTER TABLE `mst_itemgroup` ADD COLUMN IF NOT EXISTS  `itemmodel_id` varchar(10)   AFTER `itemgroup_isexselect`;
...
ALTER TABLE `mst_itemgroup` MODIFY COLUMN IF EXISTS  `itemgroup_parent` varchar(17)    AFTER `itemgroup_isparent`;
...
ALTER TABLE `mst_itemgroup` ADD KEY IF NOT EXISTS `dept_id` (`dept_id`);
...
ALTER TABLE `mst_itemgroup` ADD CONSTRAINT `fk_mst_itemgroup_mst_dept` FOREIGN KEY IF NOT EXISTS  (`dept_id`) REFERENCES `mst_dept` (`dept_id`);

...
if (is_file(__DIR__ .'/item.php-handler.php')) {
	require_once __DIR__ .'/item.php-handler.php';
}

/**
 * finact/items/item/item.php
 *
 * ===================================================================
 * Entry point Program Module item
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\item_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new item_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

...
/**
 * finact/items/item/apis/xapi.base.php
 *
 * itemBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul item
 *
...
class itemBase extends WebAPI {
	...
	protected $main_tablename = "mst_item";
	protected $main_primarykey = "item_id";
	protected $main_field_version = "item_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*item*/.txt";
		// debug::disable();

	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.item_id, A.item_name, A.item_nameshort, A.item_isdisabled, A.item_descr, A.item_stdcost, A.itemgroup_id, A.itemclass_id, A.dept_id, A._createby, A._createdate, A._modifyby, A._modifydate 
				from mst_item A
			" . $where->sql . $limit);
			$stmt->execute($where->params);

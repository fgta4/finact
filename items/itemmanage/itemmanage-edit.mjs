...
import * as hnd from  './itemmanage-edit-hnd.mjs'
...
const obj = {
	...
	txt_itemmanage_name: $('#pnl_edit-txt_itemmanage_name'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemmanage_id,
		autoid: false,
		logview: 'mst_itemmanage',
...
function form_idsetup(options) {
	var objid = obj.txt_itemmanage_id

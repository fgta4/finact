...
if (is_file(__DIR__ .'/itemmanage.php-handler.php')) {
	require_once __DIR__ .'/itemmanage.php-handler.php';
}

/**
 * finact/items/itemmanage/itemmanage.php
 *
 * ===================================================================
 * Entry point Program Module itemmanage
 * ===================================================================
 ...
 * terakhir di generate tanggal 09/02/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\itemmanage_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemmanage_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

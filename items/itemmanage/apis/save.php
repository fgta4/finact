...
/**
 * finact/items/itemmanage/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends itemmanageBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->itemmanage_id = strtoupper($obj->itemmanage_id);
			$obj->itemmanage_name = strtoupper($obj->itemmanage_name);
			...
			try {
				...
				// result
				$options->criteria = [
					"itemmanage_id" => $obj->itemmanage_id
				];

...
const obj = {
	txt_itemassetmoving_id: $('#pnl_editmovingform-txt_itemassetmoving_id'),
	dt_itemassetmoving_date: $('#pnl_editmovingform-dt_itemassetmoving_date'),
	txt_itemassetmoving_ref: $('#pnl_editmovingform-txt_itemassetmoving_ref'),
	txt_itemassetmoving_typename: $('#pnl_editmovingform-txt_itemassetmoving_typename'),
	txt_dept_name: $('#pnl_editmovingform-txt_dept_name'),
	txt_site_name: $('#pnl_editmovingform-txt_site_name'),
	txt_empl_name: $('#pnl_editmovingform-txt_empl_name'),
	txt_itemasset_id: $('#pnl_editmovingform-txt_itemasset_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemassetmoving_id,
		autoid: true,
		logview: 'log_itemassetmoving',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.itemassetmoving_date = global.now()
...
function form_idsetup(options) {
	var objid = obj.txt_itemassetmoving_id

...
/**
 * finact/items/itemasset/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header itemasset (mst_itemasset)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['mst_itemassetspec', 'trn_inquiryfiles', 'mst_itemassetdepre', 'mst_itemassetbooking', 'log_itemassetmoving', 'log_itemassetmaintenace'];

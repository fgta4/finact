...
/**
 * finact/items/itemasset/apis/spec-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel spec itemasset (mst_itemasset)
 *
...
$API = new class extends itemassetBase {
	...
	public function execute($data, $options) {
		$tablename = 'mst_itemassetspec';
		$primarykey = 'itemassetspec_id';
		...
		try {
			...
			$obj->itemassetspec_id = strtoupper($obj->itemassetspec_id);
			$obj->itemspec_id = strtoupper($obj->itemspec_id);
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'itemassetspec_id', 'itemassetspec_value', 'itemspec_id', 'itemspec_isnumber', 'itemasset_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
				...
				'itemspec_name' => \FGTA4\utils\SqlUtility::Lookup($record['itemspec_id'], $this->db, 'mst_itemspec', 'itemspec_id', 'itemspec_name'),

...
$API = new class extends itemstockBase {
	...
	public function execute($options) {
		...
		try {
			...
			$sqlFieldList = [
				'itemstock_id' => 'A.`itemstock_id`', 'itemstock_code' => 'A.`itemstock_code`', 'itemstock_name' => 'A.`itemstock_name`', 'itemstock_nameshort' => 'A.`itemstock_nameshort`',
				'itemstock_descr' => 'A.`itemstock_descr`', 'itemstock_couchdbid' => 'A.`itemstock_couchdbid`', 'itemstock_picture' => 'A.`itemstock_picture`', 'unitmeasurement_id' => 'A.`unitmeasurement_id`',
				...
				'itemstock_lastcost' => 'A.`itemstock_lastcost`', 'itemstock_lastcostdate' => 'A.`itemstock_lastcostdate`', 'itemgroup_id' => 'A.`itemgroup_id`', 'itemctg_id' => 'A.`itemctg_id`',
				'itemclass_id' => 'A.`itemclass_id`', 'unit_id' => 'A.`unit_id`', 'dept_id' => 'A.`dept_id`', 'itemstock_ref' => 'A.`itemstock_ref`',

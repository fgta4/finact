...
/**
 * finact/items/itemstock/apis/saldo-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel saldo itemstock (mst_itemstock)
	...
	public function execute($options) {
		...
		try {
			...
			$stmt = $this->db->prepare("
				select 
				A.itemstocksaldo_id, A.periodemo_id, A.unit_id, A.itemstockunitclose_id, A.itemstocksaldo_date, A.itemstocksaldo_dategen, A.site_id, A.dept_id, A.brand_id, A.unitmeasurement_id, A.itemstock_id, A.itemstocksaldo_qty, A.itemstocksaldo_value, A._createby, A._createdate, A._modifyby, A._modifydate 

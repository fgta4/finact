...
import * as hnd from  './itemstock-barcodeform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_editbarcodeform-caption')
...
const obj = {
	...
	txt_itemstockbarcode_text: $('#pnl_editbarcodeform-txt_itemstockbarcode_text'),
	txt_brand_id: $('#pnl_editbarcodeform-txt_brand_id'),

...
import * as hnd from  './itemstock-propform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_editpropform-caption')
...
const obj = {
	txt_itemstockprop_id: $('#pnl_editpropform-txt_itemstockprop_id'),
	cbo_itemproptype_id: $('#pnl_editpropform-cbo_itemproptype_id'),
	txt_itemstockprop_keys: $('#pnl_editpropform-txt_itemstockprop_keys'),
	txt_itemstockprop_value: $('#pnl_editpropform-txt_itemstockprop_value'),
	txt_itemstock_id: $('#pnl_editpropform-txt_itemstock_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemstockprop_id,
		autoid: true,
		logview: 'mst_itemstockprop',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.cbo_itemproptype_id.name = 'pnl_editpropform-cbo_itemproptype_id'		
	new fgta4slideselect(obj.cbo_itemproptype_id, {
		title: 'Pilih itemproptype_id',
		returnpage: this_page_id,
		api: $ui.apis.load_itemproptype_id,
		fieldValue: 'itemproptype_id',
		fieldDisplay: 'itemproptype_name',
		fields: [
			{mapping: 'itemproptype_id', text: 'itemproptype_id'},
			{mapping: 'itemproptype_name', text: 'itemproptype_name'}
		],
...
*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_itemproptype_id, record.itemproptype_id, record.itemproptype_name)
			.setViewMode()
			.rowid = rowid
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.itemproptype_id = '0'
		data.itemproptype_name = '-- PILIH --'
...
function form_idsetup(options) {
	var objid = obj.txt_itemstockprop_id

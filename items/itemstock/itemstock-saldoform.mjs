...
const obj = {
	txt_itemstocksaldo_id: $('#pnl_editsaldoform-txt_itemstocksaldo_id'),
	txt_periodemo_id: $('#pnl_editsaldoform-txt_periodemo_id'),
	txt_unit_id: $('#pnl_editsaldoform-txt_unit_id'),
	txt_itemstockunitclose_id: $('#pnl_editsaldoform-txt_itemstockunitclose_id'),
	txt_itemstocksaldo_date: $('#pnl_editsaldoform-txt_itemstocksaldo_date'),
	txt_itemstocksaldo_dategen: $('#pnl_editsaldoform-txt_itemstocksaldo_dategen'),
	txt_site_id: $('#pnl_editsaldoform-txt_site_id'),
	txt_dept_id: $('#pnl_editsaldoform-txt_dept_id'),
	txt_brand_id: $('#pnl_editsaldoform-txt_brand_id'),
	txt_unitmeasurement_id: $('#pnl_editsaldoform-txt_unitmeasurement_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemstocksaldo_id,
		autoid: true,
		logview: 'mst_itemstocksaldo',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_itemstocksaldo_id

...
if (is_file(__DIR__ .'/itemstock.php-handler.php')) {
	require_once __DIR__ .'/itemstock.php-handler.php';
}

/**
 * finact/items/itemstock/itemstock.php
 *
 * ===================================================================
 * Entry point Program Module itemstock
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\itemstock_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemstock_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

...
import * as hnd from  './itemstock-pictureform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_editpictureform-caption')
...
const fl_itemstockpic_file_img = $('#pnl_editpictureform-fl_itemstockpic_file_img');
const fl_itemstockpic_file_lnk = $('#pnl_editpictureform-fl_itemstockpic_file_link');				
			

const pnl_form = $('#pnl_editpictureform-form')
const obj = {
	txt_itemstockpic_id: $('#pnl_editpictureform-txt_itemstockpic_id'),
	txt_itemstockpic_couchdbid: $('#pnl_editpictureform-txt_itemstockpic_couchdbid'),
	txt_itemstockpic_name: $('#pnl_editpictureform-txt_itemstockpic_name'),
	txt_itemstockpic_descr: $('#pnl_editpictureform-txt_itemstockpic_descr'),
	txt_itemstockpic_order: $('#pnl_editpictureform-txt_itemstockpic_order'),
	fl_itemstockpic_file: $('#pnl_editpictureform-fl_itemstockpic_file'),
	txt_itemstock_id: $('#pnl_editpictureform-txt_itemstock_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_itemstockpic_id,
		autoid: true,
		logview: 'mst_itemstockpic',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.fl_itemstockpic_file.filebox({
		onChange: function(value) {
			var files = obj.fl_itemstockpic_file.filebox('files');
			var f = files[0];
				...
				return function(e) {
					if (loaded.type.startsWith('image')) {
						...
						image.onload = function() {
							fl_itemstockpic_file_img.attr('src', e.target.result);
							fl_itemstockpic_file_img.show();
							fl_itemstockpic_file_lnk.hide();
						}
					} else {
						fl_itemstockpic_file_img.hide();
						fl_itemstockpic_file_lnk.hide();
					}
				}
			})(f);
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		fl_itemstockpic_file_img.hide();
		fl_itemstockpic_file_lnk.hide();	
		obj.fl_itemstockpic_file.filebox('clear');		
...
function updatefilebox(record) {
	...
	obj.fl_itemstockpic_file.filebox('clear');			
	if (record.itemstockpic_file_doc!=undefined) {
		if (record.itemstockpic_file_doc.type.startsWith('image')) {
			fl_itemstockpic_file_lnk.hide();
			fl_itemstockpic_file_img.show();
			fl_itemstockpic_file_img.attr('src', record.itemstockpic_file_doc.attachmentdata);
		} else {
			fl_itemstockpic_file_img.hide();
			fl_itemstockpic_file_lnk.show();
			fl_itemstockpic_file_lnk[0].onclick = () => {
				fl_itemstockpic_file_lnk.attr('download', record.itemstockpic_file_doc.name);
				fl_itemstockpic_file_lnk.attr('href', record.itemstockpic_file_doc.attachmentdata);
			}
		}	
	} else {
		fl_itemstockpic_file_img.hide();
...
function form_idsetup(options) {
	var objid = obj.txt_itemstockpic_id

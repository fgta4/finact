...
if (is_file(__DIR__ .'/itemclass.php-handler.php')) {
	require_once __DIR__ .'/itemclass.php-handler.php';
}

/**
 * finact/items/itemclass/itemclass.php
 *
 * ===================================================================
 * Entry point Program Module itemclass
 * ===================================================================
 * klasifikasi barang
 *
 * Create by:
 ...
 * terakhir di generate tanggal 19/07/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\itemclass_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new itemclass_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;

...
/**
 * finact/items/itemclass/apis/files-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel files itemclass (mst_itemclassfiles)
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('doctype_name', 'doctype_id', $record, 'mst_doctype', 'doctype_name', 'doctype_id');

...
/**
 * finact/items/itemclass/apis/account-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel account itemclass (mst_itemclassaccbudget)
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('projectmodel_name', 'projectmodel_id', $record, 'mst_projectmodel', 'projectmodel_name', 'projectmodel_id');

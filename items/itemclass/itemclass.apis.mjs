...
export const load_inquiry_accbudget_id = 'finact/master/accbudget/list'
export const load_nr_coa_id = 'finact/master/coa/list'
export const load_lr_coa_id = 'finact/master/coa/list'
